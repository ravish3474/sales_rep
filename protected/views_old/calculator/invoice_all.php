...
<div class="row" id="calculator">
	<div class="row mt-20">
		<div class="col-md-12">
			<a href="<?php echo Yii::app()->request->baseUrl; ?>/calculator/FiscalYearInvoice" class="link"  >
	...
	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="x_panel">
			...
			<h2> <?php echo $year_commission." Year"; ?> 
				<select id="select_month" onchange="changeMonth();">
					<option value="01" <?php if($month_select=="01"){ echo "selected"; } ?> >January</option>
					<option value="02" <?php if($month_select=="02"){ echo "selected"; } ?> >Febuary</option>
					<option value="03" <?php if($month_select=="03"){ echo "selected"; } ?> >March</option>
					<option value="04" <?php if($month_select=="04"){ echo "selected"; } ?> >April</option>
					<option value="05" <?php if($month_select=="05"){ echo "selected"; } ?> >May</option>
					<option value="06" <?php if($month_select=="06"){ echo "selected"; } ?> >June</option>
					<option value="07" <?php if($month_select=="07"){ echo "selected"; } ?> >July</option>
					<option value="08" <?php if($month_select=="08"){ echo "selected"; } ?> >August</option>
					<option value="09" <?php if($month_select=="09"){ echo "selected"; } ?> >September</option>
					<option value="10" <?php if($month_select=="10"){ echo "selected"; } ?> >October</option>
					<option value="11" <?php if($month_select=="11"){ echo "selected"; } ?> >November</option>
					<option value="12" <?php if($month_select=="12"){ echo "selected"; } ?> >December</option>
					<option value="all" <?php if($month_select=="all"){ echo "selected"; } ?> >==All==</option>
				</select>
			</h2>
						...
						<h4 style="font-weight: 700;">SEARCH</h4>
							...
							<div class="row" style="padding-top:30px;">
								...
								<div class="col-md-12" style="text-align:center;">
									<input type="button" value="Clear" onclick="window.location.href='<?php echo Yii::app()->request->baseUrl; ?>/calculator/Invoice/year/<?php echo $year_commission;?>'" />
							...
							<tr style="background: #ffffff;">
								...
								<?php 
									...
									foreach ($getResponsible as $key_res => $value_res) {
										...
										if($value_res['sales_status'] == "1"){ $smanager = "1"; ?>
											<div class="sales_Responsible_manager">
										...
										<?php }elseif($value_res['sales_status'] == "2"){  $ssalesrep = "2"; ?>
											<div class="sales_Responsible_salesrep">
												<button class="btn btn-success" data-toggle="modal" data-target="#editDataRep" data-id="<?php echo $value_res['id'];?>" style="padding: 0px 3px;font-size: 8px;margin-bottom: 0px;">
													<i class="fa fa-pencil"></i>
												</button>
										...
										<?php }elseif($value_res['sales_status'] == "3"){ $sprocessor = "3"; ?>
											<div class="sales_Responsible_processor">
												<button class="btn btn-success" data-toggle="modal" data-target="#editDataProcessor" data-id="<?php echo $value_res['id'];?>" style="padding: 0px 3px;font-size: 8px;margin-bottom: 0px;" >
													<i class="fa fa-pencil"></i>
												</button> 
