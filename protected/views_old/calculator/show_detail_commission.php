...
<script>
	...
	$(document).ready(function() {
		$("#paymentTable").tableHeadFixer({"left" : 4}); 
	});
...
<div class="row" id="calculator">
	<div class="row mt-20">
		<div class="col-md-12">
			<a href="<?php echo Yii::app()->request->baseUrl; ?>/calculator/showSalesCommission/year/<?php echo $year_commission; ?>/sales/<?php echo $sales; ?>" class="link"  >
		...
		<div class="x_panel">
			...
			?>
				...
				<br>
					...
					<table id="paymentTable" class="table table-striped table-bordered" style="border-collapse: initial;">
						<thead>
							<tr>
							...
							<tr>
								...
								<th class="bg-blue-light text-center" > Commission <br><span style="color:#fd6262">***Please Enter information***</span></th>
								<th class="bg-blue-light text-center" > Balance </th>
								
								<th class="bg-blue-light text-center" > Payment Status </th>
								<th class="bg-blue-light text-center" > Date </th>
								<th class="bg-blue-light text-center" > Payment </th>
								<th class="bg-blue-light text-center" > Payment Method</th>
							...
							<tr>
										...
										<?php 
											if($value['invoice_status'] == "Paid"){
												if($value['invoice_date'] != "0000-00-00"){
													...
													$_month_v = array("01"=>"Jan.", "02"=>"Feb.", "03"=>"Mar.","04"=>"Apr.", "05"=>"May.", "06"=>"Jun.", "07"=>"Jul.", "08"=>"Aug.", "09"=>"Sep.", "10"=>"Oct.", "11"=>"Nov.", "12"=>"Dec."); 
													...
													list($year_v,$momth_v,$day_v) = explode("-",$invdate);
														...
														$date_v = $_month_v[$mm_v]." ".$dd_v.",  ".$yy_v;
								...
								<td class="text-center nowrap" style="vertical-align: middle;">
									<span>
										...
										?>
										&nbsp; &nbsp; 
										<a href="#" class="btn" title="Click Here to add Commission" data-toggle="modal" data-target="#editData" data-id="<?php echo $id;?>"><i class="fa fa-calculator" aria-hidden="true" style="font-size: 30px;"></i> </a>
									</span>	
								</td>
								<td class="text-center nowrap" style="vertical-align: middle;">
									<?php 
						...
						<div class="row" id="comment">
							<?php 
								$form=$this->beginWidget('CActiveForm', array(
									'id'          => 'comment-form',
									'action'      => Yii::app()->request->baseUrl . '/calculator/commentShowSale',
									'htmlOptions' => array(
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
                <?php echo $this->renderPartial('/calculator/editPayment', array('status'=>$status_commission));  ?>
			</div>
