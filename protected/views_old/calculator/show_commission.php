...
<div class="row" id="calculator">
	...
	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="x_panel">
			...
			<div class="x_content">
				...
				<div >
					<?php
						$getDate = Yii::app()->db->createCommand('select MAX(update_date) AS datedata  from calculator where sales_manager = "'.Yii::app()->user->getState('fullName').'" order by id DESC limit 1')->queryAll();
					...
					<div id="parent">
						<table id="calculatorHeaderTable" class="table table-striped table-bordered" style="border-collapse: initial;">
							...
							<tbody>
								...
								<tr>
								<?php	if($sumtotalUSD != 0 ){  ?>
									<td class="text-center" style="background-color: #87c1fb;color: #001a33;border: 1px solid #848d94 !important;font-weight: 700;">
				...
				<form id="form_checkbox1" class="form-horizontal" action="<?php echo Yii::app()->request->baseUrl; ?>/calculator/SeachShow" method="post">
						...
						<h4 style="font-weight: 700;">SEARCH</h4>
							...
							<div class="row" style="padding-top:30px;">
								<div class="col-md-12" style="text-align:center;">
									<input type="button" value="Clear" onclick="window.location.href='<?php echo Yii::app()->request->baseUrl; ?>/calculator/ShowCommissionAll/year/<?php echo $year_commission;?>'" />
	...
	?>				
					...
					<div id="freezer-Table" style="margin:0">
						<table id="calculatorUSDcomTable" class="table table-striped table-bordered table-condensed table-freeze-multi" style="border-collapse: initial;" data-scroll-max-height="600" data-cols-number="4">
							<colgroup>
							...
							<?php
								...
								<tr style="background: #ffffff;">
									...
									<?php if($value['file_path'] != "Array" && $value['file_path'] != ""){ ?>
										<a href="<?php echo Yii::app()->request->baseUrl; ?>/invoice/docs/<?php echo $value['file_path'];?>" title="Click here to see Invoice" target="_blank"> 
											<?php echo $value['invoice'];?>  <i class="fa fa-file-text-o" aria-hidden="true"></i>
										</a>
									<?php }else{?>
									...
									<td class=" nowrap" style="vertical-align: middle;text-align:left;">
										...
										<?php }	?>
										  ...
										  <a href="<?php echo Yii::app()->request->baseUrl; ?>/calculator/showCommission/year/<?php echo $year_commission; ?>/id/<?php echo $value['id'];?>" title="Click here to add Commission" ><?php echo $value['order_name'];?>  </a>
									</td>
									<?php  
										...
										if ($dd<10){
										 ...
										 //echo $date;
										?>
									<td class="text-center" style="vertical-align: middle;">  <?php echo $date."/ ".$quarter;?> </td>
								...
								<td class="text-center" style="word-wrap:break-word;vertical-align: middle;text-align:left;">  
									<?php 	
						...
						<colgroup>
							...
							<?php
								...
								<tr style="background: #ffffff;">
									...
									<td class="text-center nowrap" style="vertical-align: middle;">
										<?php echo "$ ".number_format($value['commission'] , 2)." ".$value['currency'];?>
									</td>
									<td class="text-center nowrap" style="vertical-align: middle;">
										<?php 
											if($value['invoice_status'] == "Paid"){	
								...
								<td class="text-center" style="word-wrap:break-word;vertical-align: middle;">  
									<?php 	
										if($value['update_date'] != "0000-00-00" ){ 
											$_month_name = array("01"=>"Jan.", "02"=>"Feb.", "03"=>"Mar.","04"=>"Apr.", "05"=>"May.", "06"=>"Jun.", "07"=>"Jul.", "08"=>"Aug.", "09"=>"Sep.", "10"=>"Oct.r", "11"=>"Nov.", "12"=>"Dec."); 
