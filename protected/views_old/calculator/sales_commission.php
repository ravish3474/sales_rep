...
<div class="row" id="calculator">
	...
	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="x_panel">
			...
			<div class="x_content">
			<h2> <?php echo $sales_commission." - ". $year_commission." "; ?> 
			<select id="month_selected" onchange="return changeMonthSelected();">
				<option value="">==All==</option>
				<?php
				if(!isset($month_commission)){ $month_commission=""; }
				for($i=1;$i<=12;$i++){
					$tmp_month = "";
					if($i<10){
						$tmp_month .= "0";
					...
					?>
					<option value="<?php echo $tmp_month; ?>" <?php if($tmp_month==$month_commission){ echo "selected"; } ?> ><?php echo $show_month; ?></option>
					<?php
				}
				?>
			</select>
						...
						<table id="calculatorHeaderTable" class="table table-striped table-bordered" style="border-collapse: initial;">
							<thead>
								...
								<?php	if($sumtotalUSD != 0 ){  ?>
									<th colspan="5" class="text-center" style="background-color: rgb(0, 65, 121);color:#fff;font-weight: 700;">
										<span> USD </span>
									</th>
								<?php	}
									if($sumtotalCAD != 0){  ?>			
							...
							<?php	if($sumtotalUSD != 0 ){  ?>
									...
									<th class="text-center nowrap" style="background-color: #012f5d;border: 1px solid #848d94 !important;color: #fff;">Total commissions<br>Earned</th>
									<th class="text-center nowrap" style="background-color: #012f5d;border: 1px solid #848d94 !important;color: #fff;">Balance</th>
									<th class="text-center nowrap" style="background-color: #012f5d;border: 1px solid #848d94 !important;color: #fff;">Payment received<br>from customer<br>/ Adjustment</th>
									<th class="text-center nowrap" style="background-color: #012f5d;border: 1px solid #848d94 !important;color: #fff;">Remaining Credit<br>owe to JOG</th>
							<?php	}
									if($sumtotalCAD != 0){  ?>		
									<th class="text-center nowrap" style="background-color: #012f5d;border: 1px solid #848d94 !important;color: #fff;">Total Sales</th>
									<th class="text-center nowrap" style="background-color: #012f5d;border: 1px solid #848d94 !important;color: #fff;">Total commissions<br>Earned</th>
							...
							<tbody>
								...
								<tr>
								<?php	if($sumtotalUSD != 0 ){  
											if(!isset($totalPayByCustomerUSD)){ $totalPayByCustomerUSD=0; }
											if(!isset($payCreditUSD)){ $payCreditUSD=0; }
									?>
								...
								<?php	}
									if($sumtotalCAD != 0){  
										if(!isset($totalPayByCustomerCAD)){ $totalPayByCustomerCAD=0; }
										if(!isset($payCreditCAD)){ $payCreditCAD=0; }
									?>			
									<td class="text-center nowrap" style="background-color: #87c1fb;color: #001a33;border: 1px solid #848d94 !important;font-weight: 700;">  
								...
								<?php	}
									if($sumtotalSGD != 0){ 
										if(!isset($totalPayByCustomerSGD)){ $totalPayByCustomerSGD=0; }
										if(!isset($payCreditSGD)){ $payCreditSGD=0; }
									?>
									<td class="text-center nowrap" style="background-color: #87c1fb;color: #001a33;border: 1px solid #848d94 !important;font-weight: 700;">
								...
								<?php	}
									if($sumtotalTHB != 0){  
										if(!isset($totalPayByCustomerTHB)){ $totalPayByCustomerTHB=0; }
										if(!isset($payCreditTHB)){ $payCreditTHB=0; }
									?>	
									<td class="text-center nowrap" style="background-color: #87c1fb;color: #001a33;border: 1px solid #848d94 !important;font-weight: 700;">  
					...
					<input type="hidden" name="year_commission" value="<?php echo $year_commission; ?>">
						...
						<h4 style="font-weight: 700;">SEARCH</h4>
							<div class="row" style="padding-top:10px;">
								...
								<div class="col-md-1" style="text-align:right;"><span style="font-weight: 700;"> Order No. : </span></div>
								<div class="col-md-4" >
							...
							<div class="row" style="padding-top:10px;">
								...
								<div class="col-md-4" >
									<input type="text" name="search_dateQuarter"  class="form-control" id="search_dateQuarter" value="<?php if(!empty($search_dateQuarter)){ echo $search_dateQuarter; } ?>" style="float: left;" onfocus="blur()">
								</div>
								<div class="col-md-1" style="text-align:center;font-size:18px;"> - </div>
								<div class="col-md-4" >
									<input type="text" name="search_dateQuarter2"  class="form-control" id="search_dateQuarter2" value="<?php if(!empty($search_dateQuarter2)){ echo $search_dateQuarter2; } ?>" onfocus="blur()">
								</div>
							</div>	
							<div class="row" style="padding-top:10px;">
								<div class="col-md-2" style="text-align:right;">
					...
					<div class="col-md-12" >
						<div class="btn-add">
							...
							<form id="form_search_pdf" target="_blank" action="" method="post">
								...
								<input type="hidden" name="search_ordername_form" id="search_ordername_form" value="<?php if(!empty($search_ordername)){ echo $search_ordername; } ?>">
						...
						<table id="calculatorLoancomTable" class="table table-striped table-bordered table-condensed table-freeze-multi" style="border-collapse: initial;" data-scroll-max-height="600">
							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center nowrap" style="vertical-align: middle;"> 
										<?php 
											if($value_loan['currency']=='THB'){$cicon='฿';}else{$cicon='$';}
											if($value_loan['invoice_status'] == "Paid"){
									...
									<td class="text-center nowrap" style="vertical-align: middle;"> 
										<?php 
											if($value_loan['pay_by_customer']!=0){$style='style="color:#c50202;padding:5px 10px;font-weight: 700;"';}else{$style='';}
											echo '<span '.$style.'>'.$cicon.' '.number_format($value_loan['pay_by_customer'], 2).' '.$value_loan['currency'].'</span> ';?>
									</td>
									<td class="text-center nowrap" style="vertical-align: middle;"> 
										<?php
											if($value_loan['pay_by_credit']!=0){$style='style="color:#c50202;padding:5px 10px;font-weight: 700;"';}else{$style='';}
