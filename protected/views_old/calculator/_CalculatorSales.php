...
<div class="form-group">	
	<label class=" col-md-3 col-sm-3 col-xs-12">Sales Manager <span style="color:red">*</span></label>
	<div class="col-md-9 col-sm-6 col-xs-12">
...
<div class="form-group">	
	...
	<div class="col-md-9 col-sm-6 col-xs-12">
		...
		<select class="form-control" name="Calculator[sales_status]" id="Calculator_sales_status" >
...
<div class="modal-footer">
	...
	<button type="button" class="btn btn-primary" onclick="return checkDuplicateINVSalesManager();">Save</button>
</div>

<script type="text/javascript">
function checkDuplicateINVSalesManager(){

	var cal_id = $('#edit-calculatorManager-form').find('#Calculator_id').val();
	var cal_inv = $('#edit-calculatorManager-form').find('#Calculator_invoice').val();
	var sales_manager = $('#edit-calculatorManager-form').find('#Calculator_sales_manager').val();
    ...
    $.ajax({  
        ...
        success: function(resp){ 
            ...
            if(resp.result=="duplicated"){
            	...
            	$('#edit-calculatorManager-form').submit();
            }
