...
<script>
	...
	$(document).ready(function() {
		$("#calculatorDetailTable").tableHeadFixer({"left" : 4}); 
	});
...
<div class="row" id="calculator">
	<div class="row mt-20">
		<div class="col-md-12">
			<a href="<?php echo Yii::app()->request->baseUrl; ?>/calculator/ShowInvoice/year/<?php echo $year_commission; ?>" class="link"  >
				...
				?>
					...
					<br>
						<div class="col-md-12" id="parent">	
								<table id="calculatorDetailTable" class="table table-striped table-bordered" style="border-collapse: initial;">
									<thead>
										<tr>
											
											<th colspan="4" class="text-center" style="background-color:#89939c;color:rgb(51, 67, 80);"> Invoice Payment Status </th>
											<th colspan="4" class="text-center" style="background-color:#89939c;color:rgb(51, 67, 80);"> Commission Calculator </th>
											<th colspan="4" class="text-center" style="background-color:#89939c;color:rgb(51, 67, 80);"> Commission Payment Status </th>

										</tr>
										<tr>
											<th class="bg-blue-light text-center" > Invoice <br> Payment Status </th>
											<th class="bg-blue-light text-center" > Invoice <br> Date </th>
											<th class="bg-blue-light text-center" > Invoice <br> Amount Received </th>
											<th class="bg-blue-light text-center" > Invoice <br> Payment Method </th>
											...
											<th class="bg-blue-light text-center" > Commission <br> Payment Status </th>
											<th class="bg-blue-light text-center" > Commission <br> Date </th>
											<th class="bg-blue-light text-center" > Commission <br> Pay Outs </th>
											<th class="bg-blue-light text-center" > Commission <br> Payment Method</th>
												...
												<?php 
													if($value['invoice_status'] == "Paid"){
														if($value['invoice_date'] != "0000-00-00"){
															...
															$date_v = $_month_name[$mm_v]." ".$dd_v.",  ".$yy_v;
									...
									<?php if(!empty($comments)) : ?>
										...
										<div class="row comment-box">
												...
												<div class="box" style="<?php echo $style; ?>">
													<!--<button class="btn btn-danger confirm" del-id="<?php //echo $comment['id'];?>" del-link="<?php //echo Yii::app()->request->baseUrl; ?>/calculator/deleteComment" style="float: right;">
							...
							<div class="row" id="comment">
								<?php 
									$form=$this->beginWidget('CActiveForm', array(
										'id'          => 'comment-form',
										'action'      => Yii::app()->request->baseUrl . '/calculator/commentInvoiceDetailShow',
										'htmlOptions' => array(
