	...
	<div>
		<table style="border: 1px solid #ddd;width: 100%;max-width: 100%;margin-bottom: 20px;background-color: transparent;border-spacing: 0;border-collapse: collapse;">
				...
				<tr >
					...
					<th style="background-color: #b7bdc1 ;border: 1px solid #fff ;color: #404040;text-align: center; width:70px;">'.$value_header['r1c5'].'</th>
					<th style="background-color: #d2dae0 ;border: 1px solid #fff ;color: #404040;text-align: center; width:70px;">'.$value_header['r1c6'].'</th>
					<th style="background-color: #b7bdc1 ;border: 1px solid #fff ;color: #404040;text-align: center; width:70px;">'.$value_header['r1c7'].'</th>
					<th style="background-color: #d0d0d0 ;border: 1px solid #fff ;color: #404040;text-align: center; width:70px;">'.$value_header['r1c8'].'</th>
