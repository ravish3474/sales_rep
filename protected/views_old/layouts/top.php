...
<script type="text/javascript">
    ...
    $(document).on('click','.email_submit',function(){
        ...
        if(text.length>0){
            var data = $('#reply_to_comment').serialize();
            $.ajax({
                type:'POST',
                data:data,
      ...
      <div class="modal-body">
        <form class="form-horizontal" id="conv_estimate">
          <div class="form-group">
            <label class="control-label col-sm-2" for="sales_quote_name">Sales Rep :</label>
            <div class="col-sm-10">
        ...
        <div class="modal-content">
            ...
            <div id="quote_content" class="modal-body" style="overflow-y: auto; max-height: 500px;" >
                ...
                <div id="notes_modal_div" style="display: none;">
                    <center>
                    Salesman Notes (<font color="red">Not shown in Estimate</font>)<br><pre class="alert alert-success" style="width:100%; height:100%; max-width:700px; overflow-x:auto;" id="pre_sale_note_modal"></pre>
                    </center>
                </div>
                <form id="app_quote">
