<table class="cls_tbl_currency">
	<tr>
		<th style="width: 200px; text-align: center; line-height: 1.5; ">
			Currency 
		...
		<th style="line-height: 1.5; vertical-align: top; text-align: right;">Prices in use</th>
	...
	?>
		<tr id="curr_row<?php echo $row_curr["curr_id"]; ?>" <?php if ($row_curr["enable"] == "0") {
			...
			<td style="text-align: center;">
				...
				?>
					<button id="btn_bpfusd<?php echo $row_curr["curr_id"]; ?>" type="button" onclick="return buildPricesFromUSD(<?php echo $row_curr["curr_id"]; ?>);" class="btn btn-info" style="padding: 2px 10px;"><i class="fa fa-arrow-circle-o-right"></i> <i class="fa fa-database"></i></button>
				<?php
				}
				?>
			</td>
