<table class="cls_tbl_product">
	<tr>
		<th style="width: 150px;">
			Product<br>
			<i style="font-size: 20px; color: #5D3; cursor: pointer;" class="fa fa-plus" data-toggle="modal" data-target="#adminAddProductModal" ></i>
		</th>
	...
	?>
		<tr id="prod_row<?php echo $row_product["prod_id"]; ?>" <?php if($row_product["enable"]=="0"){ echo ' class="disable_row" '; } ?>>
