...
function showPriceGuide(){
	...
	$.ajax({  
        type: "POST",  
        dataType: "html", 
        url:"<?php echo Yii::app()->request->baseUrl; ?>/priceGuideV2/showInnerUser/product/"+prod_id+"/type/"+sat_id+"/curr/"+curr_id<?php if(isset($admin_edit) && $admin_edit=="yes"){ echo '+"?ade=yes"'; } ?> ,
        success: function(resp){ 
...
function showExtraV2(){
	...
	$.ajax({  
        type: "POST",  
        dataType: "html", 
        url:"<?php echo Yii::app()->request->baseUrl; ?>/priceGuideV2/showExtraUser/prod/<?php echo $row_product[0]["prod_id"]; ?>/curr/"+curr_id<?php if(isset($admin_edit) && $admin_edit=="yes"){ echo '+"?ade=yes"'; } ?> ,
        success: function(resp){ 
            if(resp=="empty"){
...
function addExtraToCartV2(extra_id,value_id){
	...
	if($('#qdoc_id_editing').val()==null){
        ...
        $.ajax({  
            type: "POST",  
            dataType: "html", 
            url:"<?php echo Yii::app()->request->baseUrl; ?>/priceGuideV2/addExtraToCartUser" ,
            data:{
                "extra_id":extra_id,
                "value_id":value_id
            },
...
function addToCartV2(prg_id){
    ...
    if($('#qdoc_id_editing').val()==null){
        ...
        $.ajax({  
            type: "POST",  
            dataType: "html", 
            url:"<?php echo Yii::app()->request->baseUrl; ?>/priceGuideV2/addToCartUser" ,
            data:{
                "prg_id":prg_id
            },
            success: function(resp){ 
            ...
            <div id="manage_item_modal_body" class="modal-body" style="max-height: 550px; overflow-y: scroll; min-height: 350px;" >
                ...
                <div class="header_panel container" id="header_panel">
                    <div class="row" style="height: 35px;">
                        <div class="col-md-7" style="vertical-align: baseline; line-height: 2; padding: 0px;">
                            <label>Item: </label>
                           <select id="select_item_group" style="height: 28px; padding: 6px 12px; " class="btn_mitem" onchange="return showItemList();">
            ...
            <div class="modal-body" style="max-height: 500px;" >
                <form id="edit_extra_form" onsubmit="">
                    ...
                    <table class="tbl_new_extra" style="width: 100%;">
                        ...
                        <tr>
                            <th>Item name:</th><td id="edit_extra_name"></td>
                        </tr>
                        <tr>
                            <th>Description:</th><td id="edit_extra_desc"></td>
                        </tr>
                        <tr>
                            <th>User Description:</th><td><textarea id="edit_extra_desc_user" name="edit_extra_desc" ></textarea></td>
                        </tr>
                    </table>
...
function showItemList(item_id_focus=0){
    ...
    $.ajax({  
        type: "POST",  
        dataType: "json", 
        url:"<?php echo Yii::app()->request->baseUrl; ?>/priceGuideV2/showItemListUser" ,
        data: {
            "prod_id":prod_id,
            "group_id":group_id,
...
function editProductItem(item_id){
    ...
    $.ajax({  
        type: "POST",  
        dataType: "html", 
        url:"<?php echo Yii::app()->request->baseUrl; ?>/priceGuideV2/editProductItemFormUser" ,
        data: {
            "item_id":item_id
        } ,
        success: function(resp){ 
...
function submitEditItem(){
    ...
    $.ajax({  
        type: "POST",  
        dataType: "json", 
        url:"<?php echo Yii::app()->request->baseUrl; ?>/priceGuideV2/editProductItemSubmitUser" ,
...
function editExtraItem(extra_id){
    ...
    $.ajax({  
        type: "POST",  
        dataType: "json", 
        url:"<?php echo Yii::app()->request->baseUrl; ?>/priceGuideV2/editExtraItemLib" ,
        data: {
            "extra_id":extra_id
        } ,
        success: function(resp){ 
            ...
            if(resp.result=="success"){
                ...
                $('#edit_extra_id').val(resp.main_id);
                $('#edit_extra_name').html(resp.extra_name);
                $('#edit_extra_desc').html(resp.extra_desc);
                $('#edit_extra_desc_user').val(resp.description);
...
function adminSubmitEditExtra(){
    ...
    $.ajax({  
        type: "POST",  
        dataType: "json", 
        url:"<?php echo Yii::app()->request->baseUrl; ?>/priceGuideV2/editLibExtraSubmit" ,
