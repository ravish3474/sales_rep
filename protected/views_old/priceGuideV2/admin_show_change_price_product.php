	...
	?>
		<tr>
			...
			<td style="text-align:center">
				...
				<button class="btn btn-primary" onclick="undo_change_product(<?=$row_sat["percent_value"]?>,<?=$row_sat["increase_decrease"]?>,<?=$row_sat["change_id"]?>,<?=$row_sat["prod_id"]?>,<?=$row_sat["curr_id"]?>)">UNDO</button>
