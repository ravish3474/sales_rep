			...
			<div class="x_content">
                ...
                <select id="dynamic_select">
                	<?php
                		...
                		switch ($curr) {
                			case 0:
                				$btn= '<option value="'.Yii::app()->request->baseUrl.'/priceGuide/showHockeyLine/v/Sales_Dealers/?curr=0">USD North America</option>';
                				$curr_name='USD North America';
                				break;
                			case 1:
                				$btn= '<option value="'.Yii::app()->request->baseUrl.'/priceGuide/showHockeyLine/v/Sales_Dealers/?curr=1">CAD North America</option>';
                				$curr_name='CAD North America';
                				break;
                			case 2:
                				$btn= '<option value="'.Yii::app()->request->baseUrl.'/priceGuide/showHockeyLine/v/Sales_Dealers/?curr=2">USD Europe and South America</option>';
                				$curr_name='USD Europe and South America';
                				break;
                			case 3:
                				$btn= '<option value="'.Yii::app()->request->baseUrl.'/priceGuide/showHockeyLine/v/Sales_Dealers/?curr=3">USD ASIA and Australia</option>';
                				$curr_name='USD ASIA and Australia';
                				break;
                			case 4:
                				$btn= '<option value="'.Yii::app()->request->baseUrl.'/priceGuide/showHockeyLine/v/Sales_Dealers/?curr=4">THB Thai Baht</option>';
                				$curr_name='THB Thai Baht';
                				break;
                			case 5:
                				$btn= '<option value="'.Yii::app()->request->baseUrl.'/priceGuide/showHockeyLine/v/Sales_Dealers/?curr=5">SGD Singapore</option>';
                	...
                	<option value="<?php echo Yii::app()->request->baseUrl; ?>/priceGuide/showHockeyLine/v/Sales_Dealers/?curr=0">USD North America</option>
                	<option value="<?php echo Yii::app()->request->baseUrl; ?>/priceGuide/showHockeyLine/v/Sales_Dealers/?curr=1">CAD North America</option>
                	<option value="<?php echo Yii::app()->request->baseUrl; ?>/priceGuide/showHockeyLine/v/Sales_Dealers/?curr=2">USD Europe and South America</option>
                	<option value="<?php echo Yii::app()->request->baseUrl; ?>/priceGuide/showHockeyLine/v/Sales_Dealers/?curr=3">USD ASIA and Australia</option>
                	<option value="<?php echo Yii::app()->request->baseUrl; ?>/priceGuide/showHockeyLine/v/Sales_Dealers/?curr=4">THB Thai Baht</option>
                	<option value="<?php echo Yii::app()->request->baseUrl; ?>/priceGuide/showHockeyLine/v/Sales_Dealers/?curr=5">SGD Singapore</option>
                </select>
						...
						<?php
							foreach ($hockeyl as $category => $hockeylinevalue) {
								...
								<tr style="background-color: rgb(132, 132, 132);border: 1px solid #848484;outline: 0px solid #848484;">
									...
									<td class="category_hocky  nowrap" colspan="" style="vertical-align: middle;border: 1px solid #848484;    outline: 0px solid #848484;font-weight: bold;"><?php echo $category; ?></td>
									<td class="category_hocky  nowrap" colspan="" style="border: 1px solid #848484;outline: 0px solid #848484;"></td>
									<td class="category_hocky  nowrap" colspan="" style="border: 1px solid #848484;outline: 0px solid #848484;"></td>
									<td class="category_hocky  nowrap" colspan="" style="border: 1px solid #848484;outline: 0px solid #848484;"></td>
									<td class="category_hocky  nowrap" colspan="" style="border: 1px solid #848484;outline: 0px solid #848484;"></td>
								...
								<tr id="tr_<?php echo $value['id']; ?>">
									...
									<td class="" style="word-wrap:break-word;vertical-align: middle;background-color: #fff;outline: 1px solid #ddd;text-align: left;"><?php echo $value['style']; ?></td>
	...
	<div class="modal-dialog">
		<div class="modal-content">
            ...
            <?php 
				...
				<div class="form-group">
					<label class=" col-md-2 col-sm-3 col-xs-12"><?php echo $d_header->getAttributeLabel('r2c1'); ?></label>
					<div class="col-md-10 col-sm-6 col-xs-12">
						<?php echo $form->textArea($d_header, 'r2c1', array('class' => 'form-control', 'required' => true)); ?>
					</div>
				</div>

				<div class="form-group">
					<label class=" col-md-2 col-sm-3 col-xs-12"><?php echo $d_header->getAttributeLabel('r2c2'); ?></label>
					<div class="col-md-10 col-sm-6 col-xs-12">
						<?php echo $form->textArea($d_header, 'r2c2', array('class' => 'form-control', 'required' => true)); ?>
					</div>
				</div>
