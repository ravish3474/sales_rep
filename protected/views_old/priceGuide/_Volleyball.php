...
<?php $header = HeaderSalesrep::model()->findAll("type = 'Volleyball'"); ?>
...
<?php $dheader = DheaderSalesrep::model()->findAll("type = 'Volleyball'"); ?>
...
<?php } ?>
<?php $dealersheaderheader = DealersheaderSalesrep::model()->findAll("type = 'Volleyball'"); ?>
