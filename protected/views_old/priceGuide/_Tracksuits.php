...
<?php $header = HeaderSalesrep::model()->findAll("type = 'Tracksuits'"); ?>
...
<?php $dheader = DheaderSalesrep::model()->findAll("type = 'Tracksuits'"); ?>
...
<?php } ?>
<?php $dealersheaderheader = DealersheaderSalesrep::model()->findAll("type = 'Tracksuits'"); ?>
