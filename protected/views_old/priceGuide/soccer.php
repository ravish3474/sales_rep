			...
			<div class="x_content">
                ...
                <select id="dynamic_select">
                	<?php
                		...
                		switch ($curr) {
                			case 0:
                				$btn= '<option value="'.Yii::app()->request->baseUrl.'/priceGuide/soccer/?curr=0">USD North America</option>';
                				$curr_name='USD North America';
                				break;
                			case 1:
                				$btn= '<option value="'.Yii::app()->request->baseUrl.'/priceGuide/soccer/?curr=1">CAD North America</option>';
                				$curr_name='CAD North America';
                				break;
                			case 2:
                				$btn= '<option value="'.Yii::app()->request->baseUrl.'/priceGuide/soccer/?curr=2">USD Europe and South America</option>';
                				$curr_name='USD Europe and South America';
                				break;
                			case 3:
                				$btn= '<option value="'.Yii::app()->request->baseUrl.'/priceGuide/soccer/?curr=3">USD ASIA and Australia</option>';
                				$curr_name='USD ASIA and Australia';
                				break;
                			case 4:
                				$btn= '<option value="'.Yii::app()->request->baseUrl.'/priceGuide/soccer/?curr=4">THB Thai Baht</option>';
                				$curr_name='THB Thai Baht';
                				break;
                			case 5:
                				$btn= '<option value="'.Yii::app()->request->baseUrl.'/priceGuide/soccer/?curr=5">SGD Singapore</option>';
                	...
                	<option value="<?php echo Yii::app()->request->baseUrl; ?>/priceGuide/soccer/?curr=0">USD North America</option>
                	<option value="<?php echo Yii::app()->request->baseUrl; ?>/priceGuide/soccer/?curr=1">CAD North America</option>
                	<option value="<?php echo Yii::app()->request->baseUrl; ?>/priceGuide/soccer/?curr=2">USD Europe and South America</option>
                	<option value="<?php echo Yii::app()->request->baseUrl; ?>/priceGuide/soccer/?curr=3">USD ASIA and Australia</option>
                	<option value="<?php echo Yii::app()->request->baseUrl; ?>/priceGuide/soccer/?curr=4">THB Thai Baht</option>
                	<option value="<?php echo Yii::app()->request->baseUrl; ?>/priceGuide/soccer/?curr=5">SGD Singapore</option>
                </select>
                ...
                <a href="<?php echo Yii::app()->baseUrl; ?>/pdf/soccerXLS/?curr=<?php echo $curr;?>" class="xls_btn"> XLS </a>
				<a href="<?php echo Yii::app()->baseUrl; ?>/pdf/soccer/?curr=<?php echo $curr;?>" class="paf_dowload"> PDF </a>
				<div id="freezer-Table" style="margin:0">
					<table id="soccerTable" class="table table-striped table-condensed table-freeze-multi table-bordered" data-scroll-height="600"data-cols-number="1" style="border-collapse: initial;">
						<colgroup>
						...
						<tbody>
							...
							<tr>
									...
									<td class="text-center nowrap bg-cad" style="vertical-align: middle;font-weight: bold;">
										...
										?>
										<div class="add-to-cart" onclick="return addToCart(<?php echo "'soccer',".$value['id'].",'".$qty2."','".$show_qty."','".$value_header['r3c6']."'"; ?>);">
									...
									<td class="text-center nowrap bg-usd" style="vertical-align: middle;font-weight: bold;">
										...
										?>
										<div class="add-to-cart" onclick="return addToCart(<?php echo "'soccer',".$value['id'].",'".$qty3."','".$show_qty."','".$value_header['r3c7']."'"; ?>);">
									...
									<td class="text-center nowrap bg-cad" style="vertical-align: middle;font-weight: bold;">
										...
										?>
										<div class="add-to-cart" onclick="return addToCart(<?php echo "'soccer',".$value['id'].",'".$qty4."','".$show_qty."','".$value_header['r3c8']."'"; ?>);">
									...
									<td class="text-center nowrap bg-usd" style="vertical-align: middle;font-weight: bold;">
										...
										?>
										<div class="add-to-cart" onclick="return addToCart(<?php echo "'soccer',".$value['id'].",'".$qty5."','".$show_qty."','".$value_header['r3c9']."'"; ?>);">
									...
									<td class="text-center nowrap bg-cad" style="vertical-align: middle;font-weight: bold;">
										...
										?>
										<div class="add-to-cart" onclick="return addToCart(<?php echo "'soccer',".$value['id'].",'".$qty7."','".$show_qty."','".$value_header['r3c11']."'"; ?>);">
									...
									<td class="text-center nowrap bg-usd" style="vertical-align: middle;font-weight: bold;">
										...
										?>
										<div class="add-to-cart" onclick="return addToCart(<?php echo "'soccer',".$value['id'].",'".$qty8."','".$show_qty."','".$value_header['r3c12']."'"; ?>);">
									...
									<td class="text-center nowrap bg-cad" style="vertical-align: middle;font-weight: bold;">
										...
										?>
										<div class="add-to-cart" onclick="return addToCart(<?php echo "'soccer',".$value['id'].",'".$qty9."','".$show_qty."','".$value_header['r3c13']."'"; ?>);">
									...
									<td class="text-center nowrap bg-usd" style="vertical-align: middle;font-weight: bold;">
										...
										?>
										<div class="add-to-cart" onclick="return addToCart(<?php echo "'soccer',".$value['id'].",'".$qty10."','".$show_qty."','".$value_header['r3c14']."'"; ?>);">
									...
									<td class="text-center nowrap bg-cad" style="vertical-align: middle;font-weight: bold;">
										...
										?>
										<div class="add-to-cart" onclick="return addToCart(<?php echo "'soccer',".$value['id'].",'".$qty12."','".$show_qty."','".$value_header['r3c16']."'"; ?>);">
									...
									<td class="text-center nowrap bg-usd" style="vertical-align: middle;font-weight: bold;">
										...
										?>
										<div class="add-to-cart" onclick="return addToCart(<?php echo "'soccer',".$value['id'].",'".$qty13."','".$show_qty."','".$value_header['r3c17']."'"; ?>);">
									...
									<td class="text-center nowrap bg-cad" style="vertical-align: middle;font-weight: bold;">
										...
										?>
										<div class="add-to-cart" onclick="return addToCart(<?php echo "'soccer',".$value['id'].",'".$qty14."','".$show_qty."','".$value_header['r3c18']."'"; ?>);">
									...
									<td class="text-center nowrap bg-usd" style="vertical-align: middle;font-weight: bold;">
										...
										?>
										<div class="add-to-cart" onclick="return addToCart(<?php echo "'soccer',".$value['id'].",'".$qty15."','".$show_qty."','".$value_header['r3c19']."'"; ?>);">
									...
									<td class="text-center nowrap bg-price" style="vertical-align: middle;font-weight: bold;">
										...
										?>
										<div class="add-to-cart" onclick="return addToCart(<?php echo "'soccer',".$value['id'].",'".$msrp."','".$show_qty."','".$value_header['r3c20']."'"; ?>);">
