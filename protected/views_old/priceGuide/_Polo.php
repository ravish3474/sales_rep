...
<?php $header = HeaderSalesrep::model()->findAll("type = 'Polo'"); ?>
...
<?php $dheader = DheaderSalesrep::model()->findAll("type = 'Polo'"); ?>
...
<?php } ?>
<?php $dealersheaderheader = DealersheaderSalesrep::model()->findAll("type = 'Polo'"); ?>
