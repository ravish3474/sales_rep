...
<div class="form-group">
	...
	<div class="col-md-9 col-sm-6 col-xs-12">
		<?php echo $form->textField($model, 'category', array('class' => 'form-control', 'required' => true)); ?>
	</div>
</div>

<?php $header = HeaderSalesrep::model()->findAll("type = 'HockeyLine'"); ?>
...
<?php $dheader = DheaderSalesrep::model()->findAll("type = 'HockeyLine'"); ?>
...
<?php } ?>
<?php $dealersheaderheader = DealersheaderSalesrep::model()->findAll("type = 'HockeyLine'"); ?>
