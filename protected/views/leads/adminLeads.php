...
<style>
    ...
    #recentLeadsTabContent thead th {
        white-space: unset;
    }
                    ...
                    <div class="recentLeads">
                        <div class="d-flex between">
                            <ul class="nav nav-tabs" id="myTabs" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link tab_links_click" data-status="3" id="on-hold-tab" data-toggle="tab" data-count="<?php echo $hold_count ?>" href="#on-hold" role="tab" aria-controls="on-hold" aria-selected="false" aria-expanded="false">Pending
...
<script>
    function callDatatable(status = 'All', month = '<? echo date('m') ?>', sales_person = 0, year = <? echo date('Y') ?>, currentPage, search = 0) {
        showLoader();
        $.ajax({
            url: 'getAjaxTable',
            method: 'POST',
