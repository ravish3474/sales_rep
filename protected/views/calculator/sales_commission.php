<style>
	...
	select#commissionStatusSelectCAD {
		width: 100%;
		color: #5C656D;
		font-size: 12px;
		padding: 2px;
	...
	select#commissionStatusSelectSGD {
		width: 100%;
		color: #5C656D;
		font-size: 12px;
		padding: 2px;
	...
	select#commissionStatusSelectTHB {
		width: 100%;
		color: #5C656D;
		font-size: 12px;
		padding: 2px;
							...
							<thead>
								...
								<tr>
									<?php if ($sumtotalUSD != 0) {  ?>
										...
										<th class="nowrap" style="background-color: #012f5d;border: 1px solid #848d94 !important;color: #fff;font-weight: 500;">Subtract from </br>Sales Commission</th>
							...
							<tbody>
								...
								<tr>
									<?php if ($sumtotalUSD != 0) {
										...
										<td class="text-center nowrap asdasd" style="background-color: #87c1fb;color: #001a33;border: 1px solid #848d94 !important;font-weight: 700;">
											<?php if ($commissionPaymentUSD == 0) { ?>
												<span class="balancezerotop"><?php echo "$ " . number_format($commissionPaymentUSD, 2); ?></span>
											<?php } else { ?>
												<span class="balancezerotop" style="color:#c50202;padding:5px 10px;font-weight: 700;"><?php echo "$ " . number_format($commissionPaymentUSD, 2); ?></span>
											<?php } ?>
										</td>
										<td class="text-center nowrap" style="background-color: #87c1fb;color: #001a33;border: 1px solid #848d94 !important;font-weight: 700;">
									...
									?>
										...
										<td class="text-center nowrap" style="background-color: #87c1fb;color: #001a33;border: 1px solid #848d94 !important;font-weight: 700;">
											...
											<?php } else { ?>
												<span class="balancezerotopcad" style="color:#c50202;padding:5px 10px;font-weight: 700;"><?php echo "$ " . number_format($commissionPaymentCAD, 2); ?></span>
											<?php } ?>
										</td>
										<td class="text-center nowrap" style="background-color: #87c1fb;color: #001a33;border: 1px solid #848d94 !important;font-weight: 700;">
									...
									if ($sumtotalSGD != 0) {
										...
										<td class="text-center nowrap" style="background-color: #87c1fb;color: #001a33;border: 1px solid #848d94 !important;font-weight: 700;">
											...
											<?php } else { ?>
												<span class="balancezerotopSGD" style="color:#c50202;padding:5px 10px;font-weight: 700;"><?php echo "$ " . number_format($commissionPaymentSGD, 2); ?></span>
											<?php } ?>
										</td>
										<td class="text-center nowrap" style="background-color: #87c1fb;color: #001a33;border: 1px solid #848d94 !important;font-weight: 700;">
									...
									?>
										...
										<td class="text-center nowrap" style="background-color: #87c1fb;color: #001a33;border: 1px solid #848d94 !important;font-weight: 700;">
											...
											<?php } else { ?>
												<span class="balancezerotopTHB" style="color:#c50202;padding:5px 10px;font-weight: 700;"><?php echo "฿ " . number_format($commissionPaymentTHB, 2); ?></span>
											<?php } ?>
										</td>
										<td class="text-center nowrap" style="background-color: #87c1fb;color: #001a33;border: 1px solid #848d94 !important;font-weight: 700;">
				...
				<div class="col-md-12 search-form-div">
					...
					<form id="form_checkbox1" class="form-horizontal" action="<?php echo Yii::app()->request->baseUrl; ?>/calculator/seach" method="post">
						...
						<div class="row">
							...
							<div class="col-md-12 button-div" style="display: flex;">
								<input type="button" value="Clear" class="btn clear-btn" style="color: #424242;width: 100px;"  onclick="window.location.href='<?php echo Yii::app()->request->baseUrl; ?>/calculator/SalesCommission/year/<?php echo $year_commission; ?>/sales/<?php echo $sales_commission; ?>'" />
								<input type="submit" value="Submit" class=" btn submit-btn" style="color: #FFF; background: #337AB7 !important;width: 100px;">
							</div>
							...
							<table id="calculatorUSDcomTable" class="table table-striped table-bordered data_invoice table-condensed table-freeze-multi" style="border-collapse: initial;" data-scroll-max-height="600" data-cols-number="5">
								...
								<thead>
									...
									<tr>
										...
										<th class="bg-blue-light text-center" style="text-align: left;"> Invoice Status
											<select name="invoice_status" id="InvoiceStatusSelect">
										...
										<th class="bg-blue-light text-center" style="text-align: left;"> Commission Status
											<select name="commission_status" id="commissionStatusSelect">
												<option value="" selected disabled>update status</option>
												<option value="Paid">Paid</option>
												<option value="Outstanding">Outstanding</option>
											</select>
								...
								<tbody>
									...
									foreach ($getData as $key => $value) {
										if ($value['currency'] ==   $curr) {
											...
											$balance_change = ($value['commission'] - $value['pay_for_sales']) - $value['pay_by_credit'];
									?>
											<tr style="background: #ffffff;" class="checkboxnew" data-id="<?php echo $value['id']; ?>" data-balance="<?php echo $value['commission']; ?>" data-invoicestatus="<?php echo $value['invoice_status']; ?>">
												...
												<td class="text-center nowrap jogcodeinv<?php echo $value['id']; ?>" style="vertical-align: middle;">
													<?php if ($value['file_path'] != "Array" && $value['file_path'] != "") { 
														$invoices = explode(',', $value['invoice']);
														foreach ($invoices as $invoice) {
														?>
															<a href="<?php echo Yii::app()->request->baseUrl; ?>/invoice/docs/<?php echo $value['file_path']; ?>" target="_blank" style="font-weight: 600; color:#000;">
																<?php echo $invoice; ?>
															</a><br>
														<?php }
														} else { ?>														
														...
														if ($value['inv_link'] != "") {
															...
															foreach ($invoices as $invoice) {
														?>
															<a href="<?php echo $value['inv_link']; ?>" target="_blank" title="Invoice link" style="font-weight: 600; color:#000;"><?php echo $invoice; ?></a><br>
														<?php
															}
														}
														?>
												...
												<td class="text-left nowrap" style="vertical-align: middle;text-align: left">
													<div class="col-md-12 ordernoup<?php echo $value['id']; ?>" style="vertical-align: middle;">
														<?php
															$order_no = explode(',', $value['order_no']);
															foreach ($order_no as $order) {
														?>
															<span><?php echo $order; ?></span><br>
														<?php
															}
														?>
													</div>
												...
												<td class="text-left " style="vertical-align: middle;">
													...
													<div class="col-md-10 order_name<?php echo $value['id']; ?>" style="vertical-align: middle;text-align:left;">
												...
												//echo $date;
												?>
												<td class="text-center quarter<?php echo $value['id']; ?>" style="vertical-align: middle;"> <?php echo $date . "/<br>" . $quarter; ?> </td>
												<td class="text-center nowrap invoice_status<?php echo $value['id']; ?>" style="vertical-align: middle;">
													<?php
													if ($value['invoice_status'] == "Outstanding") {
														echo "<span class=\"invoicestatuschange".$value['id']."\" style=\"color:red\">" . $value['invoice_status'] . "</span>";
													} else {
														echo "<span class=\"invoicestatuschange".$value['id']."\"> " . $value['invoice_status'] . "</span>";
													}
													?>

												</td>

												<td class="text-center nowrap invoice-details<?php echo $value['id']; ?>" style="vertical-align: middle;">
													<?php
													if ($value['invoice_status'] == "Paid") {
												...
												<td class="text-l nowrap totalsale<?php echo $value['id']; ?>" style="vertical-align: middle;">
													<?php
													$totalsale = ((($value['total_sales'] - $value['shipping_cost']) - $value['creditcard_feecost'] - $value['royalty_feecost']) - $value['comp_itemcost']- $value['namebar_patches']);
												...
												<td class="text-center nowrap compercent<?php echo $value['id']; ?>" style="vertical-align: middle;">
												...
												<td class="text-center nowrap commission<?php echo $value['id']; ?>" style="vertical-align: middle;">
													<?php
												...
												<td class="text-center nowrap commissionsc<?php echo $value['id']; ?>" style="vertical-align: middle;">
													<?php
													if ($value['invoice_status'] == "Paid") {
														if ($value['commisson_payment_status'] == "Paid") {
															...
															if ($balance_invoice != 0) {
																echo "<span class=\"commissionschange".$value['id']."\" style=\"color:red\"> $ " . number_format($balance_invoice, 2) . " " . $value['currency'] . "</span>";
															} else {
															...
															if ($totalsale != 0) {
																if ($value['commission'] != 0) {
																	echo "<span class=\"commissionschange".$value['id']."\" style=\"color:red\"> $ " . number_format($value['commission'], 2) . " " . $value['currency'] . "</span>";
																} else {
												...
												<td class="text-center nowrap" style="vertical-align: middle;">
													...
													if ($value['commisson_payment_status'] == "Outstanding") {
														echo "<span class=\"statuschange".$value['id']."\" style=\"color:red\">" . $value['commisson_payment_status'] . "</span>";
													} else {
														echo "<span class=\"statuschange".$value['id']."\" > " . $value['commisson_payment_status'] . "</span>";
													}
													?>
												</td>
												<td class="text-center nowrap conmpay<?php echo $value['id']; ?>" style="vertical-align: middle;">
													<?php
													if ($value['commisson_payment_status'] == "Paid") {
												...
												<td class="text-center updatedate<?php echo $value['id']; ?>" style="word-wrap:break-word;vertical-align: middle;">
													<?php
									...
									<?php if ($sumtotalUSD != 0) {  ?>
										...
										<tr style="background-color: #c1ffe6;">
											...
											<td class="text-right nowrap " style="color: #006400;vertical-align: middle;font-weight:700;">
												...
												<?php } else { ?>
													<span class="balancezero" style="color:red;padding:5px 10px;"><?php echo "$ " . number_format($commissionPaymentUSD, 2) . " USD"; ?></span>
												<?php } ?>
											</td>
											<td></td>
											<td class="text-right nowrap" style="color: #006400;vertical-align: middle;font-weight:700;">
							...
							<table id="calculatorCADcomTable" class="table table-striped table-bordered data_invoice table-condensed table-freeze-multi" style="border-collapse: initial;" data-scroll-max-height="600" data-cols-number="5">
								...
								<thead>
									...
									<tr>
										...
										<th class="bg-blue-light text-center"> Invoice Status
											<select name="invoice_status" id="InvoiceStatusSelectCAD">
												<option value="" selected disabled>update status</option>
												<option value="Paid">Paid</option>
												<option value="Outstanding">Outstanding</option>
											</select>
										...
										<th class="bg-blue-light text-center"> Commission Status
											<select name="commission_status" id="commissionStatusSelectCAD">
												<option value="" selected disabled>update status</option>
												<option value="Paid">Paid</option>
												<option value="Outstanding">Outstanding</option>
											</select>
								...
								<tbody>
									...
									foreach ($getData as $key => $value) {
										if ($value['currency'] ==   $curr) {
									?>
											<tr style="background: #ffffff;" class="checkboxnewCAD" data-id="<?php echo $value['id']; ?>"  data-balance="<?php echo $value['commission']; ?>" data-invoicestatus="<?php echo $value['invoice_status']; ?>" >
												...
												<td class="" style="vertical-align: middle;text-align:left;">
													...
													<div class="col-md-10 order_name<?php echo $value['id']; ?>" style="vertical-align: middle;">
														<a href="<?php echo Yii::app()->request->baseUrl; ?>/calculator/commission/year/<?php echo $year_commission; ?>/id/<?php echo $value['id']; ?>"><?php echo nl2br($value['order_name']); ?> </a>
													</div>
												</td>
												<?php
												...
												<td class="text-center nowrap invoice_status<?php echo $value['id']; ?>" style="vertical-align: middle;">
													<?php
													if ($value['invoice_status'] == "Outstanding") {
														echo "<span class=\"invoicestatuschangeCAD".$value['id']."\" style=\"color:red\">" . $value['invoice_status'] . "</span>";
													} else {
														echo "<span class=\"invoicestatuschangeCAD".$value['id']."\"> " . $value['invoice_status'] . "</span>";
													}
													?>
												...
												<td class="text-center nowrap totalsale<?php echo $value['id']; ?>" style="vertical-align: middle;">
													<?php
													$totalsale = ((($value['total_sales'] - $value['shipping_cost']) - $value['creditcard_feecost'] -  $value['royalty_feecost']) - $value['comp_itemcost'] - $value['namebar_patches']);
												...
												<td class="text-center nowrap commissionsc<?php echo $value['id']; ?>" style="vertical-align: middle;">
													...
													if ($value['invoice_status'] == "Paid") {
														if ($value['commisson_payment_status'] == "Paid") {
															...
															$balance_invoice = ($value['commission'] - $value['pay_for_sales']) - $value['pay_by_credit'];
															if ($balance_invoice != 0) {
																echo "<span class=\"commissionschangecad".$value['id']."\" style=\"color:red\"> $ " . number_format($balance_invoice, 2) . " " . $value['currency'] . "</span>";
															} else {
																echo "<span> $ " . number_format($balance_invoice, 2) . " " . $value['currency'] . "</span>";
															}
														} else {
															if ($totalsale != 0) {
																if ($value['commission'] != 0) {
																	echo "<span class=\"commissionschangecad".$value['id']."\" style=\"color:red\"> $ " . number_format($value['commission'], 2) . " " . $value['currency'] . "</span>";
																} else {
																	echo "<span> $ " . number_format($value['commission'], 2) . " " . $value['currency'] . "</span>";
																}
															}
												...
												<td class="text-center nowrap" style="vertical-align: middle;">
													<?php
													if ($value['commisson_payment_status'] == "Outstanding") {
														echo "<span class=\"statuschangeCAD".$value['id']."\" style=\"color:red\">" . $value['commisson_payment_status'] . "</span>";
													} else {
														echo "<span class=\"statuschangeCAD".$value['id']."\" > " . $value['commisson_payment_status'] . "</span>";
													}
													?>
												</td>
												<td class="text-center nowrap conmpay<?php echo $value['id']; ?>" style="vertical-align: middle;">
									...
									<?php if ($sumtotalCAD != 0) {  ?>
										...
										<tr style="background-color: #c1ffe6;">
											...
											<td class="text-right nowrap" style="color: #006400;vertical-align: middle;font-weight:700;">
												...
												<?php } else { ?>
													<span class="balancezerocad" style="color:red;padding:5px 10px;"><?php echo "$ " . number_format($commissionPaymentCAD, 2) . " CAD"; ?></span>
												<?php } ?>
											</td>
											<td colspan=""></td>
											<td class="text-right nowrap" style="color: #006400;vertical-align: middle;font-weight:700;">
							...
							<table id="calculatorSGDcomTable" class="table table-striped table-bordered data_invoice table-condensed table-freeze-multi" style="border-collapse: initial;" data-scroll-max-height="600" data-cols-number="5">
								...
								<thead>
									...
									<tr>
										...
										<th class="bg-blue-light text-center"> Invoice Status
											<select name="invoice_status" id="InvoiceStatusSelectSGD">
												<option value="" selected disabled>update status</option>
												<option value="Paid">Paid</option>
												<option value="Outstanding">Outstanding</option>
											</select>
										...
										<th class="bg-blue-light text-center"> Commission Status
											<select name="commission_status" id="commissionStatusSelectSGD">
												<option value="" selected disabled>update status</option>
												<option value="Paid">Paid</option>
												<option value="Outstanding">Outstanding</option>
											</select>
								...
								<tbody>
									...
									foreach ($getData as $key => $value) {
										if ($value['currency'] ==   $curr) {
									?>
											<tr style="background: #ffffff;" class="checkboxnewSGD" data-id="<?php echo $value['id']; ?>"  data-balance="<?php echo $value['commission']; ?>" data-invoicestatus="<?php echo $value['invoice_status']; ?>">
												...
												<td class="text-center nowrap text-center nowrap jogcodeinv<?php echo $value['id']; ?>" style="vertical-align: middle;">
													<?php if ($value['file_path'] != "Array" && $value['file_path'] != "") { 
														$invoices = explode(',', $value['invoice']);
														foreach ($invoices as $invoice) {
														?>
												...
												<td class="" style="vertical-align: middle;text-align:left;">
													...
													<div class="col-md-1 order_name<?php echo $value['id']; ?>" style="vertical-align: middle;">
														<a href="<?php echo Yii::app()->request->baseUrl; ?>/calculator/commission/year/<?php echo $year_commission; ?>/id/<?php echo $value['id']; ?>"><?php echo nl2br($value['order_name']); ?> </a>
													</div>
												</td>
												<?php
												...
												<td class="text-center nowrap invoice_status<?php echo $value['id']; ?>" style="vertical-align: middle;">
													<?php
													if ($value['invoice_status'] == "Outstanding") {
														echo "<span class=\"invoicestatuschangeSGD".$value['id']."\" style=\"color:red\">" . $value['invoice_status'] . "</span>";
													} else {
														echo "<span class=\"invoicestatuschangeSGD".$value['id']."\"> " . $value['invoice_status'] . "</span>";
													}
													?>
												...
												<td class="text-center nowrap commissionsc<?php echo $value['id']; ?>" style="vertical-align: middle;">
													...
													if ($value['invoice_status'] == "Paid") {
														if ($value['commisson_payment_status'] == "Paid") {
															...
															if ($totalsale != 0) {
																if ($value['commission'] != 0) {
																	echo "<span class=\"commissionschangeSGD".$value['id']."\" style=\"color:red\"> $ " . number_format($value['commission'], 2) . " " . $value['currency'] . "</span>";
																} else {
																	echo "<span> $ " . number_format($value['commission'], 2) . " " . $value['currency'] . "</span>";
																}
															}
												...
												<td class="text-center nowrap" style="vertical-align: middle;">
													<?php
													if ($value['commisson_payment_status'] == "Outstanding") {
														echo "<span class=\"statuschangeSGD".$value['id']."\" style=\"color:red\">" . $value['commisson_payment_status'] . "</span>";
													} else { 
														echo "<span class=\"statuschangeSGD".$value['id']."\"> " . $value['commisson_payment_status'] . "</span>";
													}
													?>
												</td>
												<td class="text-center nowrap conmpay<?php echo $value['id']; ?>" style="vertical-align: middle;">
									...
									<?php if ($sumtotalSGD != 0) {  ?>
										...
										<tr style="background-color: #c1ffe6;">
											...
											<td class="text-right nowrap" style="color: #006400;vertical-align: middle;font-weight:700;">
												...
												<?php } else { ?>
													<span class="balancezeroSGD" style="color:red;padding:5px 10px;"><?php echo "$ " . number_format($commissionPaymentSGD, 2) . " SGD"; ?></span>
												<?php } ?>
											</td>
											<td></td>
											<td class="text-right nowrap" style="color: #006400;vertical-align: middle;font-weight:700;">
							...
							<table id="calculatorTHBcomTable" class="table table-striped table-bordered data_invoice table-condensed table-freeze-multi" style="border-collapse: initial;" data-scroll-max-height="600" data-cols-number="5">
								...
								<thead>
									...
									<tr>
										...
										<th class="bg-blue-light text-center"> Invoice Status
											<select name="invoice_status" id="InvoiceStatusSelectTHB">
												<option value="" selected disabled>update status</option>
												<option value="Paid">Paid</option>
												<option value="Outstanding">Outstanding</option>
											</select>
										...
										<th class="bg-blue-light text-center"> Commission Status
											<select name="commission_status" id="commissionStatusSelectTHB">
												<option value="" selected disabled>update status</option>
												<option value="Paid">Paid</option>
												<option value="Outstanding">Outstanding</option>
											</select>
								...
								<tbody>
									...
									foreach ($getData as $key => $value) {
										if ($value['currency'] ==   $curr) {
									?>
											<tr style="background: #ffffff;" class="checkboxnewTHB" data-id="<?php echo $value['id']; ?>"  data-balance="<?php echo $value['commission']; ?>" data-invoicestatus="<?php echo $value['invoice_status']; ?>" >
												...
												<td class="text-center nowrap invoice_status<?php echo $value['id']; ?>" style="vertical-align: middle;">
													<?php
													if ($value['invoice_status'] == "Outstanding") {
														echo "<span class=\"invoicestatuschangeTHB".$value['id']."\" style=\"color:red\">" . $value['invoice_status'] . "</span>";
													} else {
														echo "<span class=\"invoicestatuschangeTHB".$value['id']."\" > " . $value['invoice_status'] . "</span>";
													}
													?>
												...
												<td class="text-center nowrap " style="vertical-align: middle;">
													...
													if ($value['invoice_status'] == "Paid") {
														if ($value['commisson_payment_status'] == "Paid") {
															...
															if ($totalsale != 0) {
																if ($value['commission'] != 0) {
																	echo "<span class=\"commissionschangeTHB".$value['id']."\" style=\"color:red\"> ฿ " . number_format($value['commission'], 2) . " " . $value['currency'] . "</span>";
																} else {
																	echo "<span> ฿ " . number_format($value['commission'], 2) . " " . $value['currency'] . "</span>";
																}
															}
									...
									<?php if ($sumtotalTHB != 0) {  ?>
										...
										<tr style="background-color: #c1ffe6;">
											...
											<td class="text-right nowrap" style="color: #006400;vertical-align: middle;font-weight:700;">
												...
												<?php } else { ?>
													<span class="balancezeroTHB" style="color:red;padding:5px 10px;"><?php echo "฿ " . number_format($commissionPaymentTHB, 2) . " THB"; ?></span>
												<?php } ?>
											</td>
											<td></td>
											<td class="text-right nowrap" style="color: #006400;vertical-align: middle;font-weight:700;">
						...
						<table id="calculatorLoancomTable" class="table table-striped table-bordered table-condensed table-freeze-multi" style="border-collapse: initial;" data-scroll-max-height="600">
							<thead>
								<tr>
									...
									<th class="bg-blue-light text-center">Subtract from </br>Sales Commission</th>
...
<script>
$(document).ready(function() {
	$('#InvoiceStatusSelect').change(function(event) {
            ...
            cancelButtonText: 'No, Cancel'
				...
				if (result.isConfirmed) {
					...
					$('.checkboxnew').each(function() {
						...
						var balance = checkbox.data('balance');
						var invoicestatus = checkbox.data('invoicestatus');
									
						
						// Store the AJAX request in the array
						ajaxRequests.push($.ajax({
							type: 'POST',
							url: "<?php echo Yii::app()->request->baseUrl; ?>/calculator/UpdateInvoiceStatus",
							data: {
								id: id,
								balance: balance,
							...
							success: function(response) {								
								if(selectedStatus == 'Paid'){				
									$('.invoicestatuschange' + id).html(selectedStatus);
									$('.invoicestatuschange' + id).css("color", "grey");
									$('.commissionschange' + id).html('$ 0.00 USD');
									$('.commissionschange' + id).css("color", "grey");
									$('.balancezero').html('$ 0.00 USD');
									$('.balancezerotop').html('$ 0.00 USD');
									$('.balancezerotop').css("color", "black");
									$('.balancezero').css("color", "green");
									
								}else{
									$('.invoicestatuschange' + id).html(selectedStatus);
									$('.invoicestatuschange' + id).css("color", "red");	
								}																				
							},
					...
					// Optional: Reset the dropdown back to previous value
					$('#InvoiceStatusSelect').val('');
				}
		})						
	});
});
$(document).ready(function() {
	$('#InvoiceStatusSelectCAD').change(function(event) {
		var selectedStatus = $(this).val();	
		Swal.fire({
			title: 'Are you sure you want to Update?',
            type: 'warning',
				...
				if (result.isConfirmed) {						
					...
					$('.checkboxnewCAD').each(function() {
						...
						ajaxRequests.push($.ajax({
							...
							success: function(response) {								
								if(selectedStatus == 'Paid'){				
									$('.invoicestatuschangeCAD' + id).html(selectedStatus);
									$('.invoicestatuschangeCAD' + id).css("color", "grey");
									$('.commissionschange' + id).html('$ 0.00 USD');
									$('.commissionschange' + id).css("color", "grey");
									$('.balancezero').html('$ 0.00 USD');
									$('.balancezerotop').html('$ 0.00 USD');
									...
									$('.invoicestatuschangeCAD' + id).html(selectedStatus);
									$('.invoicestatuschangeCAD' + id).css("color", "red");	
								}																				
							},
							error: function(xhr, status, error) {
								console.error(xhr.responseText);
					...
					// Optional: Reset the dropdown back to previous value
					$('#InvoiceStatusSelectCAD').val('');
				}
		})						
	});
});
$(document).ready(function() {
	$('#InvoiceStatusSelectSGD').change(function(event) {
		var selectedStatus = $(this).val();	
		Swal.fire({
			title: 'Are you sure you want to Update?',
            type: 'warning',
				...
				if (result.isConfirmed) {			
					...
					$('.checkboxnewSGD').each(function() {
						...
						ajaxRequests.push($.ajax({
							...
							success: function(response) {								
								if(selectedStatus == 'Paid'){				
									$('.invoicestatuschangeSGD' + id).html(selectedStatus);
									$('.invoicestatuschangeSGD' + id).css("color", "grey");
									$('.commissionschange' + id).html('$ 0.00 USD');
									$('.commissionschange' + id).css("color", "grey");
									$('.balancezero').html('$ 0.00 USD');
									$('.balancezerotop').html('$ 0.00 USD');
									...
									$('.invoicestatuschangeSGD' + id).html(selectedStatus);
									$('.invoicestatuschangeSGD' + id).css("color", "red");	
								}																				
							},
							error: function(xhr, status, error) {
								console.error(xhr.responseText);
					...
					// Optional: Reset the dropdown back to previous value
					$('#InvoiceStatusSelectSGD').val('');
				}	
		})						
	});
});
$(document).ready(function() {
	$('#InvoiceStatusSelectTHB').change(function(event) {
		var selectedStatus = $(this).val();	
		Swal.fire({
			title: 'Are you sure you want to Update?',
            type: 'warning',
				...
				if (result.isConfirmed) {						
					...
					$('.checkboxnewTHB').each(function() {
						...
						ajaxRequests.push($.ajax({
							...
							success: function(response) {								
								if(selectedStatus == 'Paid'){				
									$('.invoicestatuschangeTHB' + id).html(selectedStatus);
									$('.invoicestatuschangeTHB' + id).css("color", "grey");
									$('.commissionschange' + id).html('$ 0.00 USD');
									$('.commissionschange' + id).css("color", "grey");
									$('.balancezero').html('$ 0.00 USD');
									$('.balancezerotop').html('$ 0.00 USD');
									...
									$('.invoicestatuschangeTHB' + id).html(selectedStatus);
									$('.invoicestatuschangeTHB' + id).css("color", "red");	
								}																				
							},
							error: function(xhr, status, error) {
								console.error(xhr.responseText);
...
$(document).ready(function() {
	$('#commissionStatusSelect').change(function(event) {
		var selectedStatus = $(this).val();
		Swal.fire({
			title: 'Are you sure you want to Update?',
            type: 'warning',
            ...
            cancelButtonText: 'No, Cancel'
				...
				if (result.isConfirmed) {
					...
					$('.checkboxnew').each(function() {
						...
						ajaxRequests.push($.ajax({
							type: 'POST',
							url: "<?php echo Yii::app()->request->baseUrl; ?>/calculator/UpdateCommissionStatus",
							data: {
								id: id,
								balance: balance,
								selectedStatus: selectedStatus,
							...
							success: function(response) {
								...
								if(invoicestatus == 'Paid'){	
									if(selectedStatus == 'Paid'){				
										$('.statuschange' + id).html(selectedStatus);
										$('.statuschange' + id).css("color", "grey");
										$('.commissionschange' + id).html('$ 0.00 USD');
										$('.commissionschange' + id).css("color", "grey");
										$('.balancezero').html('$ 0.00 USD');
										$('.balancezerotop').html('$ 0.00 USD');
...
$(document).ready(function() {
	$('#commissionStatusSelectCAD').change(function(event) {
		var selectedStatus = $(this).val();
		Swal.fire({
			...
			$('.checkboxnewCAD').each(function() {
				...
				ajaxRequests.push($.ajax({
					...
					success: function(response) {
						if(invoicestatus == 'Paid'){
							if(selectedStatus == 'Paid'){				
								$('.statuschangeCAD' + id).html(selectedStatus);
								$('.statuschangeCAD' + id).css("color", "grey");
								
								$('.commissionschangecad' + id).html('$ 0.00 CAD');
								$('.commissionschangecad' + id).css("color", "grey");
								$('.balancezerocad').html('$ 0.00 CAD');
								$('.balancezerotopcad').html('$ 0.00 CAD');
								$('.balancezerotopcad').css("color", "black");
								$('.balancezerocad').css("color", "green");
							}else{
								$('.statuschangeCAD' + id).html(selectedStatus);
								$('.statuschangeCAD' + id).css("color", "red");	
							}							
						}
					},
					error: function(xhr, status, error) {
...
$(document).ready(function() {
	$('#commissionStatusSelectSGD').change(function(event) {
		var selectedStatus = $(this).val();
		Swal.fire({
			title: 'Are you sure want to Update?',			
			type: 'warning',
			...
			$('.checkboxnewSGD').each(function() {
				...
				ajaxRequests.push($.ajax({
					...
					success: function(response) {
						if(invoicestatus == 'Paid'){
							if(selectedStatus == 'Paid'){				
								$('.statuschangeSGD' + id).html(selectedStatus);
								$('.statuschangeSGD' + id).css("color", "grey");
								
								$('.commissionschangeSGD' + id).html('$ 0.00 SGD');
								$('.commissionschangeSGD' + id).css("color", "grey");
								$('.balancezeroSGD').html('$ 0.00 SGD');
								$('.balancezerotopSGD').html('$ 0.00');
								$('.balancezerotopSGD').css("color", "black");
								$('.balancezeroSGD').css("color", "green");
							}else{
								$('.statuschangeSGD' + id).html(selectedStatus);
								$('.statuschangeSGD' + id).css("color", "red");	
							}
						}
					},
					error: function(xhr, status, error) {
...
$(document).ready(function() {
	$('#commissionStatusSelectTHB').change(function(event) {
		var selectedStatus = $(this).val();
		Swal.fire({
			title: 'Are you sure want to Update?',			
			type: 'warning',
			...
			$('.checkboxnewTHB').each(function() {
				...
				ajaxRequests.push($.ajax({
					...
					success: function(response) {
						if(invoicestatus == 'Paid'){
							if(selectedStatus == 'Paid'){				
								$('.statuschangeTHB' + id).html(selectedStatus);
								$('.statuschangeTHB' + id).css("color", "grey");
								
								$('.commissionschangeTHB' + id).html('฿ 0.00 THB');
								$('.commissionschangeTHB' + id).css("color", "grey");
								$('.balancezeroTHB').html('฿ 0.00 THB');
								$('.balancezerotopTHB').html('฿ 0.00');
								$('.balancezerotopTHB').css("color", "black");
								$('.balancezeroTHB').css("color", "green");
							}else{
								$('.statuschangeTHB' + id).html(selectedStatus);
								$('.statuschangeTHB' + id).css("color", "red");	
							}
						}						
					},
					error: function(xhr, status, error) {
