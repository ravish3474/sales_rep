...
<script>
	$(document).ready(function() {
		$("#calculatorTable").tableHeadFixer({
			"left": 1
		});
	});
</script>
		...
		<div class="x_panel">
			...
			<div class="x_title">
				...
				<div class="d-flex gap2">
					...
					<a href="<?php echo Yii::app()->baseUrl; ?>/pdf/commissionAll/year/<?php echo $year_commission; ?>" class="paf_dowload" style="float: unset; margin-bottom: 0;" target="_blank"> PDF </a>

				</div>
			</div>
			<div class="x_content">
				<div class="d-flex gap2" style="    justify-content: space-between;     padding-bottom: 10px;">
					<h2 class="mSize">
						<i class="fa fa-file-text-o" aria-hidden="true"></i> <?php echo $year_commission . " Year"; ?>
						...
						<tbody>
							...
							?>
								<tr>
									...
									<td class="text-right bg-usd nowrap" style="color: red; background-color:#e9e9e9 !important">
										<?php
									...
									<td class="text-right bg-cad nowrap" style="color: red; background-color:#e9e9e9 !important">
										<?php
					...
					<thead>
						<tr>
							<th class="bg-blue-light">
								<a href="#" class="btn " data-toggle="modal" data-target="#editNotes" style="padding: 1px 5px; background: #FFF ;float: right;     margin: 0;"><i class="fa fa-pencil"></i> Edit</a>
								Notes
							</th>
						</tr>
					</thead>
