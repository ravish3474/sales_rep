...
<div class="row" id="calculator">
	<div class="row mt-20">
		<div class="col-md-12">
			<a href="<?php echo Yii::app()->request->baseUrl; ?>/calculator/showSales/year/<?php echo $year_commission; ?>" class="link"  >
	...
	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="x_panel">
			...
			<div class="x_content">
						...
						foreach ($getSale as $key => $value) {
							...
							if($value['currency'] == "USD"){
								...
								if($value['invoice_status'] == "Paid"){
									...
									//$sumCommissionPaymaentUSD += $value['pay_for_sales'];
							...
							if($value['currency'] == "CAD"){
								...
								if($value['invoice_status'] == "Paid"){
								/*	
									$sumCommissionPaymaentCAD += $value['pay_for_sales'];
							...
							if($value['currency'] == "SGD"){
								...
								if($value['invoice_status'] == "Paid"){
								/*	
									$sumCommissionPaymaentSGD += $value['pay_for_sales'];
							...
							if($value['currency'] == "THB"){
								...
								if($value['invoice_status'] == "Paid"){
								/*
									$sumCommissionPaymaentTHB += $value['pay_for_sales'];
							...
							<tbody>
								...
								<?php	}
									...
									<td class="text-center nowrap" style="background-color: #87c1fb;color: #001a33;border: 1px solid #848d94 !important;font-weight: 700;"> 
										...
										<span><?php echo "$ ".number_format($commissionPaymentCAD);?></span>
										<?php }else{ ?>
										<span style="color:red;padding:5px 10px;"><?php echo "$ ".number_format($commissionPaymentCAD);?></span>
										<?php } ?>
									</td>
								<?php	}
									if($sumtotalSGD != 0){  ?>
				...
				<form id="form_checkbox1" class="form-horizontal" action="<?php echo Yii::app()->request->baseUrl; ?>/calculator/SeachShowSalesCommission" method="post">
						...
						<h4 style="font-weight: 700;">SEARCH</h4>
							<div class="row" style="padding-top:10px;">
								...
								<div class="col-md-4" >
									...
									if(Yii::app()->user->getState('userGroup') == 99 || Yii::app()->user->getState('userGroup') == 1){
										$db_invoice = Yii::app()->db->createCommand('select invoice from calculator where invoice != "" AND date_quarter LIKE "'.$year_commission.'%" group by invoice order by invoice ASC')->queryAll(); 
										
									}elseif(Yii::app()->user->getState('userGroup') == 2){
										$db_invoice = Yii::app()->db->createCommand('select invoice from calculator where invoice != ""  AND sales_manager = "'.Yii::app()->user->getState('fullName').'" AND date_quarter LIKE "'.$year_commission.'%" group by invoice order by invoice ASC')->queryAll(); 
									}	 ?>
							...
							<div class="row" style="padding-top:10px;">
								...
								<div class="col-md-4" >
									...
									if(Yii::app()->user->getState('userGroup') == 99 || Yii::app()->user->getState('userGroup') == 1){
										$db_orderno = Yii::app()->db->createCommand('select order_no from calculator where order_no != "" AND date_quarter LIKE "'.$year_commission.'%" group by order_no order by order_no ASC')->queryAll();
										
									}elseif(Yii::app()->user->getState('userGroup') == 2){
										$db_orderno = Yii::app()->db->createCommand('select order_no from calculator where order_no != "" AND sales_manager = "'.Yii::app()->user->getState('fullName').'" AND date_quarter LIKE "'.$year_commission.'%" group by order_no order by order_no ASC')->queryAll();
									}	
							...
							<div class="row" style="padding-top:30px;">
								<div class="col-md-12" style="text-align:center;">
									<input type="button" value="Clear" onclick="window.location.href='<?php echo Yii::app()->request->baseUrl; ?>/calculator/showSalesCommission/year/<?php echo $year_commission;?>/sales/<?php echo $sales_commission;?>'" />
					...
					<div >
							...
							<a href="<?php echo Yii::app()->baseUrl; ?>/calculator/ShowSalesPosition/year/<?php echo $year_commission;?>/sales/<?php echo $sales_commission;?>/positions/All"><i class="fa fa-user" aria-hidden="true"></i> ALL </a> &nbsp;&nbsp; 
							<a href="<?php echo Yii::app()->baseUrl; ?>/calculator/ShowSalesPosition/year/<?php echo $year_commission;?>/sales/<?php echo $sales_commission;?>/positions/1"><i class="fa fa-user" aria-hidden="true"></i> Sales Manager (M)</a> &nbsp;&nbsp; 
							<a href="<?php echo Yii::app()->baseUrl; ?>/calculator/ShowSalesPosition/year/<?php echo $year_commission;?>/sales/<?php echo $sales_commission;?>/positions/2"><i class="fa fa-user" aria-hidden="true"></i> Sales Rep (R)</a> &nbsp;&nbsp; 
							<a href="<?php echo Yii::app()->baseUrl; ?>/calculator/ShowSalesPosition/year/<?php echo $year_commission;?>/sales/<?php echo $sales_commission;?>/positions/3"><i class="fa fa-user" aria-hidden="true"></i> Processor (P) </a>
						</div>
					<br>
	<?php 
		$currency_curr = array_unique ($currency);
			foreach($currency_curr as $curr) {
				if( $curr == "USD"){ ?>
					...
					<div id="freezer-Table" style="margin:0">
						<table id="calculatorUSDTable" class="table table-striped table-bordered table-condensed table-freeze-multi" style="border-collapse: initial;" data-scroll-max-height="600"data-cols-number="4">
							<colgroup>
							...
							<?php
								...
								<tr style="background: #ffffff;">
									...
									<td class="nowrap" style="vertical-align: middle;text-align:left;"> 
										
									<?php if($value['file_path'] != "Array" && $value['file_path'] != ""){ ?>
										<a href="<?php echo Yii::app()->request->baseUrl; ?>/invoice/docs/<?php echo $value['file_path'];?>" title="Click here to see Invoice" target="_blank"> 
									...
									<td class="" style="vertical-align: middle;text-align:left;">
										...
										<div class="col-md-10" style="vertical-align: middle;">	
										  <a href="<?php echo Yii::app()->request->baseUrl; ?>/calculator/showCommission/year/<?php echo $year_commission; ?>/id/<?php echo $value['id'];?>" title="Click here to add Commission"><?php echo nl2br($value['order_name']);?>  </a>
										</div> 
									</td>
									<?php  
									...
									<td class="text-center nowrap" style="vertical-align: middle;text-align:left;">
										<?php 
											$totalsale = (($value['total_sales'] - $value['shipping_cost']) - $value['creditcard_feecost'] - $value['royalty_feecost'] - $value['namebar_patches']);
			...
			foreach($currency_curr as $curr){ 
				if( $curr == "CAD"){ ?>
					...
					<div id="freezer-Table" style="margin:0">
						<table id="calculatorCADTable" class="table table-striped table-bordered table-condensed table-freeze-multi" style="border-collapse: initial;" data-scroll-max-height="600"data-cols-number="4">
							<colgroup>
							<col style="width:150px;">
							<col style="width:120px;">
							<col style="width:150px;">
			...
			<?php }}
				...
				if( $curr == "SGD"){ ?>
					...
					<div id="freezer-Table" style="margin:0">
						<table id="calculatorSGDTable" class="table table-striped table-bordered table-condensed table-freeze-multi" style="border-collapse: initial;" data-scroll-max-height="600"data-cols-number="4">	
							<colgroup>
							<col style="width:150px;">
							<col style="width:120px;">
							<col style="width:150px;">
								...
								<tr style="background: #ffffff;">
									...
									<?php 
										if($value['commisson_payment_status'] == "Paid"){
											...
											if($value['date_for_sales'] != "0000-00-00" ){ 
												$_month_name_comm = array("01"=>"Jan.y",  "02"=>"Feb.",  "03"=>"Mar.",    
												"04"=>"Apr.",  "05"=>"May.",  "06"=>"Jun.",    
												"07"=>"Jul.",  "08"=>"Aug.",  "09"=>"Sep.",    
												"10"=>"Oct.", "11"=>"Nov.",  "12"=>"Dec."); 
				...
				<div style="margin-bottom:10px;">
					...
					<div id="freezer-Table" style="margin:0">
						<table id="calculatorTHBTable" class="table table-striped table-bordered table-condensed table-freeze-multi" style="border-collapse: initial;" data-scroll-max-height="600"data-cols-number="4">
							<colgroup>
							<col style="width:150px;">
							<col style="width:120px;">
							<col style="width:150px;">
