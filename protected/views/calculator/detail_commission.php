...
<div class="row" id="calculator">
	<div class="row mt-20">
		<div class="col-md-12">
			<a href="<?php echo Yii::app()->request->baseUrl; ?>/calculator/SalesCommission/year/<?php echo $year_commission; ?>/sales/<?php echo $sales; ?>" class="link"  >
							...
							<div class="row" id="comment">
								<?php 
									$form=$this->beginWidget('CActiveForm', array(
										'id'          => 'comment-form',
										'action'      => Yii::app()->request->baseUrl . '/calculator/commentShow',
										'htmlOptions' => array(
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
                <?php echo $this->renderPartial('/calculator/editCalculatorDetailCommission');  ?>
			</div>
