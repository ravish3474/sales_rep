...
<?php echo $a_product['prod_detail']; ?></h2>
<?php echo $a_sale_type['sat_name']; ?> Pricing</h3>
<table >
    <tr>
        <td style="width:80%">
            <h2>All Products</h2>
...
<table class="tbl_show_pguide" style="width:<?php echo $table_width; ?>px;border-collapse: 0px;">
	<thead>
	<tr class="tr_head">
		<th class="fix_head1" style="width: 180px;background-color: #5c656d;
		color: #FFF;
		border: 1px solid #848d94;
		text-align: center;
		padding: 5px;" rowspan="2">
			Product
			<?php
		...
		<th class="fix_head1" style="width: 280px;background-color: #5c656d;
		color: #FFF;
		border: 1px solid #848d94;
		text-align: center;
	...
	<tr class="tr_head">
		<th class="fix_head2" style="background-color: #5c656d;
		color: #FFF;
		border: 1px solid #848d94;
		text-align: center;
		padding: 5px;">Sales Commission</th>
		<?php
...
<table class="tbl_notes">
	...
	<tr>
		...
		<td colspan="2"><?php echo $row_extra["extra_value"]; ?></td>
	</tr>
	<?php
	}
	?>
