...
<script type="text/javascript">
    ...
    function showPriceGuide() {
        ...
        $.ajax({
            type: "POST",
            dataType: "html",
            url: "<?php echo Yii::app()->request->baseUrl; ?>/priceGuideV2/showInnerUser/product/" + prod_id + "/type/" + sat_id + "/curr/" + curr_id<?php if (isset($admin_edit) && $admin_edit == "yes") {
                                                                                                                                                            echo '+"?ade=yes"';
                                                                                                                                                        } ?>,
            success: function(resp) {
    ...
    function showExtraV2() {
        ...
        $.ajax({
            type: "POST",
            dataType: "html",
            url: "<?php echo Yii::app()->request->baseUrl; ?>/priceGuideV2/showExtraUser/prod/<?php echo $row_product[0]["prod_id"]; ?>/curr/" + curr_id<?php if (isset($admin_edit) && $admin_edit == "yes") {
                                                                                                                                                            echo '+"?ade=yes"';
                                                                                                                                                        } ?>,
            success: function(resp) {
                if (resp == "empty") {
                ...
                <div class="modal-body" style="max-height: 500px;">
                    <form id="edit_extra_form" onsubmit="">
                        ...
                        <table class="tbl_new_extra" style="width: 100%;">
                            ...
                            <tr>
                                <th>Item name:</th>
                                <td id="edit_extra_name"></td>
                            </tr>
                            <tr>
                                <th>Description:</th>
                                <td id="edit_extra_desc"></td>
                            </tr>
                            <tr>
                                <th>User Description:</th>
                                <td><textarea id="edit_extra_desc_user" name="edit_extra_desc"></textarea></td>
                            </tr>
                        </table>
