<?php
$table_width = 495+180+280+(sizeof($a_comm)*60);
...
<table class="tbl_show_pguide" style="width:<?php echo $table_width; ?>px;">
	...
	<tr class="tr_head">
	    <?php
	    if($a_sale_type['sat_name']!="Dealers" && $a_sale_type['sat_name']!="Factory Direct"){
	    ?>
	...
	<tr>
		...
		<td style="width: 280px; text-align: left; color: #000;"><?php echo nl2br($a_item[$i]["item_style"]." ".$a_item[$i]["item_detail"]." ".$a_item[$i]["item_fabric_opt"]); ?></td>
...
<br><br>
<table class="tbl_notes" style="width:<?php echo $table_width; ?>px;">
	<thead>
		<tr>
			<th>Extras</th>
			<th>Description</th>
			<th style="text-align: right;">Flat Rate Price(<?php echo $row_curr["curr_name"]; ?>)</th>
			<th style="text-align: right;">Price (QTY 15-99)(<?php echo $row_curr["curr_name"]; ?>)</th>
			<th style="text-align: right;">Price (QTY 100-299)(<?php echo $row_curr["curr_name"]; ?>)</th>
			<th style="text-align: right;">Price (QTY 300+)(<?php echo $row_curr["curr_name"]; ?>)</th>
		</tr>
	</thead>
	<tbody>
	<?php
	...
	<tr>
		...
		<td style="text-align: right;"><?php echo ($row_extra["extra_value"] == 0.00) ? '-' : $row_extra["extra_value"]; ?></td>
		<td style="text-align: right;"><?php echo ($row_extra["extra_value_1"] == 0.00) ? '-' : $row_extra["extra_value_1"]; ?>
</td>
		<td style="text-align: right;"><?php echo ($row_extra["extra_value_2"] == 0.00) ? '-' : $row_extra["extra_value_2"]; ?>
</td>
		<td style="text-align: right;"><?php echo ($row_extra["extra_value_3"] == 0.00) ? '-' : $row_extra["extra_value_3"]; ?>
</td>
	</tr>
	<?php
	}
