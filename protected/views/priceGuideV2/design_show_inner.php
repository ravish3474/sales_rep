...
<div id="lower_table" style="max-height:1200px; max-width:100; overflow: scroll;">
	<table class="tbl_show_pguide" style="width:100%;">

		<tr class="tr_head">
			<th class="fix_head1 position-relative" style="width: 180px; padding:3px;" rowspan="1">
				Product
				<?php
		...
		<tr class="tr_head " style="position:relative !important; z-index: 101; top: auto;">
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$('#lower_table').css("max-width", card_width + "12000px");
