...
<table class="tbl_show_pguide" style="width:<?php echo $table_width; ?>px;">
	...
	<tr class="tr_head">
	    ...
	    if($sat_id=="3" || $sat_id=="6" || $comm_type=="7"){}else{
	    ?>
...
<table class="tbl_notes" style="width: 100%;">
	<thead>
		<tr>
			<th>Extras</th>
			<th>Description</th>
			<th class="bg-blue-light" style="text-align: right;">Flat Rate Price</th>
    		<th class="bg-blue-light" style="text-align: right;">Price (QTY 15-99) </th>
    		<th class="bg-blue-light" style="text-align: right;">Price (QTY 100-299) </th>
    		<th class="bg-blue-light" style="text-align: right;">Price (QTY 300+) </th>
		</tr>
	</thead>
	<tbody>
	<?php
	...
	<tr>
		...
		<td style="text-align: right;"><?php if($row_extra["extra_value"]=="0.00"){
			        echo "-";
			    }else{
				echo $row_extra["extra_value"];
			    } ?></td>
		<td style="text-align: right;"><?php if($row_extra["extra_value_1"]=="0.00"){
			        echo "-";
			    }else{
				echo $row_extra["extra_value_1"];
			    } ?></td>
		<td style="text-align: right;"><?php if($row_extra["extra_value_2"]=="0.00"){
			        echo "-";
			    }else{
				echo $row_extra["extra_value_2"];
			    } ?></td>
		<td  style="text-align: right;"><?php if($row_extra["extra_value_3"]=="0.00"){
			        echo "-";
			    }else{
