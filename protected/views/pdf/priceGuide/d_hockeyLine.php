...
<h3>Sales Dealers Pricing</h3>
	<div>
		<table style="border: 1px solid #ddd;width: 100%;max-width: 100%;margin-bottom: 20px;background-color: transparent;border-spacing: 0;border-collapse: collapse;">
				...
				$header = Yii::app()->db->createCommand('select * from dheader where type = "HockeyLine" ')->queryAll();
				...
				<tr >
					...
					<th style="background-color: #d2dae0 ;border: 1px solid #fff ;color: #404040;text-align: center;">'.$value_header['r1c10'].'</th>
					<th style="background-color: #b7bdc1 ;border: 1px solid #fff ;color: #404040;text-align: center;">'.$value_header['r1c11'].'</th>
					<th style="background-color: #d2dae0 ;border: 1px solid #fff ;color: #404040;text-align: center;">'.$value_header['r1c12'].'</th>
					<th style="background-color: #b7bdc1 ;border: 1px solid #fff ;color: #404040;text-align: center;">'.$value_header['r1c13'].'</th>
					<th style="background-color: #d2dae0 ;border: 1px solid #fff ;color: #404040;text-align: center;">'.$value_header['r1c14'].'</th>
				</tr>
				<tr >
				...
				<tr >
					...
					<th style="background-color: #b7bdc1 ;border: 1px solid #fff ;color: #404040;text-align: center;white-space: nowrap;">'.$value_header['r3c5'].'</th>
					...
					<th style="background-color: #d2dae0 ;border: 1px solid #fff ;color: #404040;text-align: center;white-space: nowrap;">'.$value_header['r3c10'].'</th>
					<th style="background-color: #b7bdc1 ;border: 1px solid #fff ;color: #404040;text-align: center;white-space: nowrap;">'.$value_header['r3c11'].'</th>
					<th style="background-color: #d2dae0 ;border: 1px solid #fff ;color: #404040;text-align: center;white-space: nowrap;">'.$value_header['r3c12'].'</th>
					<th style="background-color: #b7bdc1 ;border: 1px solid #fff ;color: #404040;text-align: center;white-space: nowrap;">'.$value_header['r3c13'].'</th>
					<th style="background-color: #d2dae0 ;border: 1px solid #fff ;color: #404040;text-align: center;white-space: nowrap;">'.$value_header['r3c14'].'</th>
				</tr>';
					}
			$html .= '	
					</thead>
		...
		$html .= 
						'<tr>
							<td colspan="12" style="background-color: #848484;color: #fff;white-space: nowrap;text-align: left;border: 1px solid #fff;padding:5px 10px;;font-weight: bold;">'. $hockeyLinevalue['category'] .'</td>
						</tr>';
