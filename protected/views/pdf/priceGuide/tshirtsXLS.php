...
header("Content-Disposition: attachment; filename=PG_Sales_Direct_Tshirts_".date("Ymd").".xls");
header("Expires: 0");
...
$toppic = Yii::app()->db->createCommand('select *  from category where type = "Tshirts" ')->queryAll();
...
<h3>Sales Direct Pricing</h3>
	<div>
		...
		<table style="border: 1px solid #ddd;width: 100%;max-width: 100%;margin-bottom: 20px;background-color: transparent;border-spacing: 0;border-collapse: collapse;">
			<thead style="display: table-header-group;vertical-align: middle;border-color: inherit;">';
				$header = Yii::app()->db->createCommand('select * from header where type = "Tshirts" ')->queryAll();
				...
				<tr>
					...
					<th style="background-color: #5c656d ;border: 1px solid #848d94 ;color: #fff;border-top: 0;vertical-align: middle;padding: 8px;line-height: 1.42857143;text-align: center;font-weight: bold;"> '.$value_header['r1c2'].'</th>
					<th style="background-color: #5c656d ;border: 1px solid #848d94 ;color: #fff;border-top: 0;vertical-align: middle;padding: 8px;line-height: 1.42857143;text-align: center;font-weight: bold;"> '.$value_header['r1c3'].'</th>
					<th style="background-color: #5c656d ;border: 1px solid #848d94 ;color: #fff;border-top: 0;vertical-align: middle;padding: 8px;line-height: 1.42857143;text-align: center;font-weight: bold;"> '.$value_header['r1c4'].'</th>
				...
				<tr>
					<th style="background-color: #5c656d ;border: 1px solid #848d94 ;color: #fff;border-top: 0;vertical-align: middle;padding: 8px;line-height: 1.42857143;text-align: center;font-weight: bold;white-space: nowrap;">'.$value_header['r2c1'].'</th>
					<th style="background-color: #5c656d ;border: 1px solid #848d94 ;color: #fff;border-top: 0;vertical-align: middle;padding: 8px;line-height: 1.42857143;text-align: center;font-weight: bold;" colspan="3">'.$value_header['r2c2'].'</th>
					<th style="background-color: #d2dae0 ;border: 1px solid #fff ;color: #404040;text-align: center;" colspan="13">'.$curr_name.'</th>
				</tr>
				<tr>
					<th style="background-color: #252c2f !important;border: 1px solid #848d94 !important;color: #fff;" colspan="4">'.$value_header['r3c1_2'].'</th>
					...
					<th style="background-color: #d2dae0;color: #404040;white-space: nowrap;text-align: center;border: 1px solid #fff;padding-left:5px;padding-right:5px;" >'.$value_header['r3c11'].'</th>
					<th style="background-color: #b7bdc1;color: #404040;white-space: nowrap;text-align: center;border: 1px solid #fff;padding-left:5px;padding-right:5px;" >'.$value_header['r3c12'].'</th>
					<th style="background-color: #d2dae0;color: #404040;white-space: nowrap;text-align: center;border: 1px solid #fff;padding-left:5px;padding-right:5px;" >'.$value_header['r3c13'].'</th>
					<th style="background-color: #b7bdc1;color: #404040;white-space: nowrap;text-align: center;border: 1px solid #fff;padding-left:5px;padding-right:5px;" >'.$value_header['r3c14'].'</th>
					
					<th style="background-color: #d2dae0;color: #404040;white-space: nowrap;text-align: center;border: 1px solid #fff;padding-left:5px;padding-right:5px;" >'.$value_header['r316'].'</th>
	...
	$html .= 	'			
			...
			<tbody>';
				$tshirtsDetail = Yii::app()->db->createCommand('select *  from tshirts order by sort_data ASC')->queryAll();
					foreach ($tshirtsDetail as $key => $value) {
						switch ($curr) {
									case 0:
										$qty2= $value['qty2'];
										$qty3= $value['qty3'];
	...
	$html .= 	'<tr>
					...
					<td style="border: 1px solid #ddd;color: #000;padding: 0 5px;">'. $value['fabric_options'].'</td>
	...
	$html .=
		'<table style="border: 1px solid #ddd;width: 100%;max-width: 100%;margin-bottom: 20px;background-color: transparent;border-spacing: 0;border-collapse: collapse;">
			...
			<tbody>';
			$notes= Yii::app()->db->createCommand('select *  from notes where type = "Tshirts"')->queryAll();
