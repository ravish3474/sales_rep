...
/*$html = '
<img src="https://jogsports.com/salesrep/images/jog-logo3.png" class="img-responsive" style="width:30px;margin-bottom:20px;" alt="1">&nbsp; &nbsp;
<img src="https://jogsports.com/salesrep/images/jog_athl.png" class="img-responsive" style="width:100px;" alt="1">';*/
$html = '';
...
<h3>Sales Direct Pricing</h3>
	<div>
		<table style="border: 1px solid #ddd;width: 100%;max-width: 100%;margin-bottom: 20px;background-color: transparent;border-spacing: 0;border-collapse: collapse;">
			<thead style="display: table-header-group;vertical-align: middle;border-color: inherit;">';
				...
				$header = Yii::app()->db->createCommand('select * from header where type = "HockeyLine" ')->queryAll();
					foreach ($header as $key_header => $value_header) {
				
				$html .= '		
				<tr >
					<th style="background-color: #5c656d ;border: 1px solid #848d94 ;color: #fff;border-top: 0;vertical-align: middle;padding: 8px;line-height: 1.42857143;text-align: center;font-weight: bold;">'.$value_header['r1c1'].'</th>
					<th style="background-color: #5c656d ;border: 1px solid #848d94 ;color: #fff;border-top: 0;vertical-align: middle;padding: 8px;line-height: 1.42857143;text-align: left;font-weight: bold;width:200px;font-size:14px;">'.$value_header['r1c2'].'</th>
					...
					<th style="background-color: #d2dae0 ;border: 1px solid #fff ;color: #404040;text-align: center;">'.$value_header['r1c8'].'</th>
					<th style="background-color: #b7bdc1 ;border: 1px solid #fff ;color: #404040;text-align: center;">'.$value_header['r1c9'].'</th>
					
					<th style="background-color: #d2dae0 ;border: 1px solid #fff ;color: #404040;text-align: center;">'.$value_header['r1c11'].'</th>
					<th style="background-color: #b7bdc1 ;border: 1px solid #fff ;color: #404040;text-align: center;">'.$value_header['r1c12'].'</th>
					<th style="background-color: #d2dae0 ;border: 1px solid #fff ;color: #404040;text-align: center;">'.$value_header['r1c13'].'</th>
					<th style="background-color: #b7bdc1 ;border: 1px solid #fff ;color: #404040;text-align: center;">'.$value_header['r1c14'].'</th>
					
					<th style="background-color: #d2dae0 ;border: 1px solid #fff ;color: #404040;text-align: center;">'.$value_header['r1c16'].'</th>
					<th style="background-color: #b7bdc1 ;border: 1px solid #fff ;color: #404040;text-align: center;">'.$value_header['r1c17'].'</th>
					<th style="background-color: #d2dae0 ;border: 1px solid #fff ;color: #404040;text-align: center;">'.$value_header['r1c18'].'</th>
					<th style="background-color: #b7bdc1 ;border: 1px solid #fff ;color: #404040;text-align: center;">'.$value_header['r1c19'].'</th>
					<th style="background-color: #d0d0d0 ;border: 1px solid #fff ;color: #333;text-align: center;">'.$value_header['r1c20'].'</th>
					
				</tr>
				<tr >
					<th style="background-color: #5c656d ;border: 1px solid #848d94 ;color: #fff;font-size:14px;">'.$value_header['r2c1'].'</th>
					<th style="background-color: #5c656d ;border: 1px solid #848d94 ;color: #fff;text-align: left;font-size:14px;">'.$value_header['r2c2'].'</th>
					
					<th style="background-color: #d2dae0 ;border: 1px solid #fff ;color: #404040;text-align: center;" colspan="13">'.$curr_name.'</th>
				</tr>
				<tr >
					<th style="background-color: #252c2f ;border: 1px solid #848d94 ;color: #fff;" colspan="2">'.$value_header['r3c1_2'].'</th>
					
					<th style="background-color: #d2dae0 ;border: 1px solid #fff ;color: #404040;text-align: center;white-space: nowrap;">'.$value_header['r3c6'].'</th>
					<th style="background-color: #b7bdc1 ;border: 1px solid #fff ;color: #404040;text-align: center;white-space: nowrap;">'.$value_header['r3c7'].'</th>
					<th style="background-color: #d2dae0 ;border: 1px solid #fff ;color: #404040;text-align: center;white-space: nowrap;">'.$value_header['r3c8'].'</th>
					<th style="background-color: #b7bdc1 ;border: 1px solid #fff ;color: #404040;text-align: center;white-space: nowrap;">'.$value_header['r3c9'].'</th>
					
					<th style="background-color: #d2dae0 ;border: 1px solid #fff ;color: #404040;text-align: center;white-space: nowrap;">'.$value_header['r3c11'].'</th>
					<th style="background-color: #b7bdc1 ;border: 1px solid #fff ;color: #404040;text-align: center;white-space: nowrap;">'.$value_header['r3c12'].'</th>
					<th style="background-color: #d2dae0 ;border: 1px solid #fff ;color: #404040;text-align: center;white-space: nowrap;">'.$value_header['r3c13'].'</th>
					<th style="background-color: #b7bdc1 ;border: 1px solid #fff ;color: #404040;text-align: center;white-space: nowrap;">'.$value_header['r3c14'].'</th>
					
					<th style="background-color: #d2dae0 ;border: 1px solid #fff ;color: #404040;text-align: center;white-space: nowrap;">'.$value_header['r3c16'].'</th>
					<th style="background-color: #b7bdc1 ;border: 1px solid #fff ;color: #404040;text-align: center;white-space: nowrap;">'.$value_header['r3c17'].'</th>
					<th style="background-color: #d2dae0 ;border: 1px solid #fff ;color: #404040;text-align: center;white-space: nowrap;">'.$value_header['r3c18'].'</th>
					<th style="background-color: #b7bdc1 ;border: 1px solid #fff ;color: #404040;text-align: center;white-space: nowrap;">'.$value_header['r3c19'].'</th>
					<th style="background-color: #d0d0d0 ;border: 1px solid #fff ;color: #333;text-align: center;">'.$value_header['r3c20'].'</th>
				</tr>';
					}
			$html .= '	
			</thead>
	...
	$html .= 
				'<tr>
					<td colspan="18" style="background-color: #848484;color: #fff;white-space: nowrap;text-align: left;border: 1px solid #fff;padding:5px 10px;">'. $hockeyLinevalue['category'] .'</td>
				</tr>';					
