...
header("Content-Disposition: attachment; filename=PG_Sales_Dealers_Hoodies_".date("Ymd").".xls");
header("Expires: 0");
...
<h3>Sales Dealers Pricing</h3>
	...
	$html .= '
		<table style="border: 1px solid #ddd;width: 100%;max-width: 100%;margin-bottom: 20px;background-color: transparent;border-spacing: 0;border-collapse: collapse;">
			<thead style="display: table-header-group;vertical-align: middle;border-color: inherit;">';
				...
				$header = Yii::app()->db->createCommand('select * from dheader where type = "Hoodies" ')->queryAll();
	...
	$html .= 	'<tr>
					...
					<td style="border: 1px solid #ddd;color: #000;padding: 5px 5px;text-align: center;">'. $value['notes'].'</td>
