...
header("Content-Disposition: attachment; filename=PG_Sales_Direct_HockeyLine_".date("Ymd").".xls");
header("Expires: 0");
...
<h3>Sales Direct Pricing</h3>
	...
	$html .= 
				'<tr>
					<td colspan="15" style="background-color: #848484;color: #fff;white-space: nowrap;text-align: left;border: 1px solid #fff;padding:5px 10px;">'. $hockeyLinevalue['category'] .'</td>
				</tr>';					
