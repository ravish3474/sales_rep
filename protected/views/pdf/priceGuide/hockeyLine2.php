...
<h3>Sales Direct Pricing</h3>
	<div>
		<table style="border: 1px solid #ddd;width: 100%;max-width: 100%;margin-bottom: 20px;background-color: transparent;border-spacing: 0;border-collapse: collapse;">
			<thead style="display: table-header-group;vertical-align: middle;border-color: inherit;">';
				...
				<tr >
					<th style="background-color: #252c2f ;border: 1px solid #848d94 ;color: #fff;" >'.$value_header['r3c1_2'].'</th>
	...
	$html .= 
				'<tr>
					<td colspan="17" style="background-color: #848484;color: #fff;white-space: nowrap;text-align: left;border: 1px solid #fff;padding:5px 10px;">'. $hockeyLinevalue['category'] .'</td>
				</tr>';					
