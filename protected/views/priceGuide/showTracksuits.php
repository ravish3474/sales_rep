			...
			<div class="x_content">
                ...
                <select id="dynamic_select">
                	<?php
                		...
                		switch ($curr) {
                			case 0:
                				$btn= '<option value="'.Yii::app()->request->baseUrl.'/priceGuide/showTracksuits/?curr=0">USD North America</option>';
                				$curr_name='USD North America';
                				break;
                			case 1:
                				$btn= '<option value="'.Yii::app()->request->baseUrl.'/priceGuide/showTracksuits/?curr=1">CAD North America</option>';
                				$curr_name='CAD North America';
                				break;
                			case 2:
                				$btn= '<option value="'.Yii::app()->request->baseUrl.'/priceGuide/showTracksuits/?curr=2">USD Europe and South America</option>';
                				$curr_name='USD Europe and South America';
                				break;
                			case 3:
                				$btn= '<option value="'.Yii::app()->request->baseUrl.'/priceGuide/showTracksuits/?curr=3">USD ASIA and Australia</option>';
                				$curr_name='USD ASIA and Australia';
                				break;
                			case 4:
                				$btn= '<option value="'.Yii::app()->request->baseUrl.'/priceGuide/showTracksuits/?curr=4">THB Thai Baht</option>';
                				$curr_name='THB Thai Baht';
                				break;
                			case 5:
                				$btn= '<option value="'.Yii::app()->request->baseUrl.'/priceGuide/showTracksuits/?curr=5">SGD Singapore</option>';
                	...
                	<option value="<?php echo Yii::app()->request->baseUrl; ?>/priceGuide/showTracksuits/?curr=0">USD North America</option>
                	<option value="<?php echo Yii::app()->request->baseUrl; ?>/priceGuide/showTracksuits/?curr=1">CAD North America</option>
                	<option value="<?php echo Yii::app()->request->baseUrl; ?>/priceGuide/showTracksuits/?curr=2">USD Europe and South America</option>
                	<option value="<?php echo Yii::app()->request->baseUrl; ?>/priceGuide/showTracksuits/?curr=3">USD ASIA and Australia</option>
                	<option value="<?php echo Yii::app()->request->baseUrl; ?>/priceGuide/showTracksuits/?curr=4">THB Thai Baht</option>
                	<option value="<?php echo Yii::app()->request->baseUrl; ?>/priceGuide/showTracksuits/?curr=5">SGD Singapore</option>
                </select>
				...
				<div id="freezer-Table" style="margin:0">
					<table id="tracksuitsTable" class="table table-striped table-condensed table-freeze-multi table-bordered" data-scroll-height="600" data-cols-number="2" style="border-collapse: initial;">
						<colgroup>
							<col>
						...
						<tbody>
							...
							<tr id="tr_<?php echo $value['id']; ?>">
								<td class="tbl-btn-box nowrap" style="vertical-align: middle;background-color: #fff;outline: 1px solid #ddd;">
									...
									<button class="btn btn-danger confirm" del-id="<?php echo $value['id'];?>" del-link="<?php echo Yii::app()->request->baseUrl; ?>/priceGuide/deleteTracksuits">
								...
								<td id="prod_name<?php echo $value['id'];?>" style="word-wrap:break-word;vertical-align: middle;background-color: #fff;outline: 1px solid #ddd;"><?php echo $value['category']; ?></td>
								<td id="prod_desc<?php echo $value['id'];?>" style="word-wrap:break-word;vertical-align: middle;background-color: #fff;outline: 1px solid #ddd;text-align: left;"><?php echo nl2br($value['discription'].$show_addi_info); ?></td>
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">JOG Price List 2017 (Prices USD) - Add</h4>
			</div>
			<div class="modal-body">
                <?php echo $this->renderPartial('/priceGuide/addTracksuits');  ?>
			</div>
			<div class="modal-footer">
				<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
				<button type="button" class="btn btn-primary" id="submit-tracksuits">Save</button>
			</div>
		</div>
	</div>
</div>
...
<div class="modal fade" id="editData" tabindex="-1" role="dialog">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
				<h4 class="modal-title">JOG Price List 2017 (Prices USD) - Edit</h4>
			</div>
			<div class="modal-body">
                <?php echo $this->renderPartial('/priceGuide/editTracksuits');  ?>
			</div>
			<div class="modal-footer">
				<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
				<button type="button" class="btn btn-primary" id="edit-submit-tracksuits">Save</button>
			</div>
		</div>
	</div>
</div>
...
<div class="modal fade" id="editHeader" tabindex="-1" role="dialog">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
				<h4 class="modal-title">Tracksuits - Headers</h4>
			</div>
			<div class="modal-body">
            ...
            <?php 
				...
				<div class="form-group">
					<label class=" col-md-2 col-sm-3 col-xs-12"><?php echo $header->getAttributeLabel('r1c3'); ?></label>
					<div class="col-md-10 col-sm-6 col-xs-12">
						
						<?php echo $form->textArea($header, 'r1c3', array('class' => 'form-control', 'required' => true)); ?>
					</div>
				</div>

				<div class="form-group">
					<label class=" col-md-2 col-sm-3 col-xs-12"><?php echo $header->getAttributeLabel('r1c4'); ?></label>
					<div class="col-md-10 col-sm-6 col-xs-12">
						<?php echo $form->textArea($header, 'r1c4', array('class' => 'form-control', 'required' => true)); ?>
					</div>
				</div>
...
<div class="modal fade" id="editsortdata" tabindex="-1" role="dialog">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
				<h4 class="modal-title">Tracksuits - Sortdata</h4>
			</div>
			<div class="modal-body">
				<div >
					...
					?>
								<div class="ui-state-default " style="padding: 5px 5px;font-size:14px;">
									...
									<?php echo $s.".";?> <?php echo $value['category']; ?></span><br> <span style="font-size:12px;"><?php echo nl2br($value['discription']); ?></span>
								</div>
					<?php
							$s++;
							}
				...
				?>
					<input type="hidden" name="type" value="Tracksuits">
