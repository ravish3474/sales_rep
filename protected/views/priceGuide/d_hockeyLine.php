			...
			<div class="x_content">
                ...
                <select id="dynamic_select">
                	<?php
                		...
                		switch ($curr) {
                			case 0:
                				$btn= '<option value="'.Yii::app()->request->baseUrl.'/priceGuide/hockeyLine/v/Sales_Dealers/?curr=0">USD North America</option>';
                				$curr_name='USD North America';
                				break;
                			case 1:
                				$btn= '<option value="'.Yii::app()->request->baseUrl.'/priceGuide/hockeyLine/v/Sales_Dealers/?curr=1">CAD North America</option>';
                				$curr_name='CAD North America';
                				break;
                			case 2:
                				$btn= '<option value="'.Yii::app()->request->baseUrl.'/priceGuide/hockeyLine/v/Sales_Dealers/?curr=2">USD Europe and South America</option>';
                				$curr_name='USD Europe and South America';
                				break;
                			case 3:
                				$btn= '<option value="'.Yii::app()->request->baseUrl.'/priceGuide/hockeyLine/v/Sales_Dealers/?curr=3">USD ASIA and Australia</option>';
                				$curr_name='USD ASIA and Australia';
                				break;
                			case 4:
                				$btn= '<option value="'.Yii::app()->request->baseUrl.'/priceGuide/hockeyLine/v/Sales_Dealers/?curr=4">THB Thai Baht</option>';
                				$curr_name='THB Thai Baht';
                				break;
                			case 5:
                				$btn= '<option value="'.Yii::app()->request->baseUrl.'/priceGuide/hockeyLine/v/Sales_Dealers/?curr=5">SGD Singapore</option>';
                	...
                	<option value="<?php echo Yii::app()->request->baseUrl; ?>/priceGuide/hockeyLine/v/Sales_Dealers/?curr=0">USD North America</option>
                	<option value="<?php echo Yii::app()->request->baseUrl; ?>/priceGuide/hockeyLine/v/Sales_Dealers/?curr=1">CAD North America</option>
                	<option value="<?php echo Yii::app()->request->baseUrl; ?>/priceGuide/hockeyLine/v/Sales_Dealers/?curr=2">USD Europe and South America</option>
                	<option value="<?php echo Yii::app()->request->baseUrl; ?>/priceGuide/hockeyLine/v/Sales_Dealers/?curr=3">USD ASIA and Australia</option>
                	<option value="<?php echo Yii::app()->request->baseUrl; ?>/priceGuide/hockeyLine/v/Sales_Dealers/?curr=4">THB Thai Baht</option>
                	<option value="<?php echo Yii::app()->request->baseUrl; ?>/priceGuide/hockeyLine/v/Sales_Dealers/?curr=5">SGD Singapore</option>
                </select>
                ...
                <a href="<?php echo Yii::app()->baseUrl; ?>/pdf/dhockeyLineXLS/?curr=<?php echo $curr;?>" class="xls_btn"> XLS </a>
				<a href="<?php echo Yii::app()->baseUrl; ?>/pdf/dhockeyLine/?curr=<?php echo $curr;?>" class="paf_dowload"> PDF </a>
					...
					<table id="hockeyLineTable" class="table table-striped table-condensed table-freeze-multi table-bordered" style="border-collapse: initial;" data-scroll-height="600"data-cols-number="1">
						...
						<?php foreach ($getDheader as $key_header => $value_header) { ?>
								...
								<tr>
									...
									<th class="bg-cad text-center" ><?php echo $value_header['r2c10']; ?></th>
									<th class="bg-usd text-center" ><?php echo $value_header['r2c11']; ?></th>
									<th class="bg-cad text-center" ><?php echo $value_header['r2c12']; ?></th>
									<th class="bg-usd text-center" ><?php echo $value_header['r2c13']; ?></th>
									<th class="bg-price text-center" ><?php echo $value_header['r2c14']; ?></th>-->
								...
								<tr>
									...
									<th class="bg-usd text-center" ><?php echo $value_header['r3c11']; ?></th>
									<th class="bg-cad text-center" ><?php echo $value_header['r3c12']; ?></th>
									<th class="bg-usd text-center" ><?php echo $value_header['r3c13']; ?></th>
									<th class="bg-price text-center" ><?php echo $value_header['r3c14']; ?></th>
						...
						<tbody>
							<?php
								...
								?>
								<tr style="background-color: rgb(132, 132, 132);">
									<td class="category_hocky" colspan="" style="vertical-align: middle;outline: 0px solid #848484;border: 1px solid #848484 !important;text-align:left;font-weight: bold;"><?php echo $category; ?></td>
									<td class="category_hocky" colspan="" style="vertical-align: middle;outline: 0px solid #848484;border: 1px solid #848484 !important;"><?php  ?></td>
									<td class="category_hocky" colspan="" style="vertical-align: middle;outline: 0px solid #848484;border: 1px solid #848484 !important;"><?php  ?></td>
									<td class="category_hocky" colspan="" style="vertical-align: middle;outline: 0px solid #848484;border: 1px solid #848484 !important;"><?php  ?></td>
									<td class="category_hocky" colspan="" style="vertical-align: middle;outline: 0px solid #848484;border: 1px solid #848484 !important;"><?php  ?></td>
									<td class="category_hocky" colspan="" style="vertical-align: middle;outline: 0px solid #848484;border: 1px solid #848484 !important;"><?php  ?></td>
							...
							<tr>
								...
								<td style="word-wrap:break-word;vertical-align: middle;background-color: #fff;outline: 1px solid #ddd;text-align: left;"><?php echo $value['discription'].$show_addi_info; ?></td>
								<td class=" nowrap bg-usd" style="vertical-align: middle;font-weight: bold;">
									<?php 
										...
										?>
										<div class="add-to-cart" onclick="return addToCart(<?php echo "'hockey_line',".$value['id'].",'".$d_qty1."','".$show_qty."','".$value_header['r3c5']."'"; ?>);">
								...
								<td class=" nowrap bg-cad" style="vertical-align: middle;font-weight: bold;">
									<?php 
										...
										?>
										<div class="add-to-cart" onclick="return addToCart(<?php echo "'hockey_line',".$value['id'].",'".$d_qty2."','".$show_qty."','".$value_header['r3c6']."'"; ?>);">
								...
								<td class=" nowrap bg-usd" style="vertical-align: middle;font-weight: bold;">
									<?php 
										...
										?>
										<div class="add-to-cart" onclick="return addToCart(<?php echo "'hockey_line',".$value['id'].",'".$d_qty3."','".$show_qty."','".$value_header['r3c7']."'"; ?>);">
								...
								<td class=" nowrap bg-cad" style="vertical-align: middle;font-weight: bold;">
									<?php 
										...
										?>
										<div class="add-to-cart" onclick="return addToCart(<?php echo "'hockey_line',".$value['id'].",'".$d_qty4."','".$show_qty."','".$value_header['r3c8']."'"; ?>);">
								...
								<td class=" nowrap bg-usd" style="vertical-align: middle;font-weight: bold;">
									<?php 
										...
										?>
										<div class="add-to-cart" onclick="return addToCart(<?php echo "'hockey_line',".$value['id'].",'".$d_qty5."','".$show_qty."','".$value_header['r3c9']."'"; ?>);">
								...
								<td class=" nowrap bg-cad" style="vertical-align: middle;font-weight: bold;">
									<?php 
										...
										?>
										<div class="add-to-cart" onclick="return addToCart(<?php echo "'hockey_line',".$value['id'].",'".$d_qty6."','".$show_qty."','".$value_header['r3c10']."'"; ?>);">
								...
								<td class=" nowrap bg-usd" style="vertical-align: middle;font-weight: bold;">
									<?php 
										...
										?>
										<div class="add-to-cart" onclick="return addToCart(<?php echo "'hockey_line',".$value['id'].",'".$d_qty7."','".$show_qty."','".$value_header['r3c11']."'"; ?>);">
								...
								<td class=" nowrap bg-cad" style="vertical-align: middle;font-weight: bold;">
									<?php 
										...
										?>
										<div class="add-to-cart" onclick="return addToCart(<?php echo "'hockey_line',".$value['id'].",'".$d_qty8."','".$show_qty."','".$value_header['r3c12']."'"; ?>);">
								...
								<td class=" nowrap bg-usd" style="vertical-align: middle;font-weight: bold;">
									<?php 
										...
										?>
										<div class="add-to-cart" onclick="return addToCart(<?php echo "'hockey_line',".$value['id'].",'".$d_qty9."','".$show_qty."','".$value_header['r3c13']."'"; ?>);">
								...
								<td class=" nowrap bg-price" style="vertical-align: middle;font-weight: bold;">
									<?php 
										...
										?>
										<div class="add-to-cart" onclick="return addToCart(<?php echo "'hockey_line',".$value['id'].",'".$d_msrp."','".$show_qty."','".$value_header['r3c14']."'"; ?>);">
