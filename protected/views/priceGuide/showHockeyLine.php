			...
			<div class="x_content">
                ...
                <select id="dynamic_select">
                	<?php
                		...
                		switch ($curr) {
                			case 0:
                				$btn= '<option value="'.Yii::app()->request->baseUrl.'/priceGuide/showHockeyLine/?curr=0">USD North America</option>';
                				$curr_name='USD North America';
                				break;
                			case 1:
                				$btn= '<option value="'.Yii::app()->request->baseUrl.'/priceGuide/showHockeyLine/?curr=1">CAD North America</option>';
                				$curr_name='CAD North America';
                				break;
                			case 2:
                				$btn= '<option value="'.Yii::app()->request->baseUrl.'/priceGuide/showHockeyLine/?curr=2">USD Europe and South America</option>';
                				$curr_name='USD Europe and South America';
                				break;
                			case 3:
                				$btn= '<option value="'.Yii::app()->request->baseUrl.'/priceGuide/showHockeyLine/?curr=3">USD ASIA and Australia</option>';
                				$curr_name='USD ASIA and Australia';
                				break;
                			case 4:
                				$btn= '<option value="'.Yii::app()->request->baseUrl.'/priceGuide/showHockeyLine/?curr=4">THB Thai Baht</option>';
                				$curr_name='THB Thai Baht';
                				break;
                			case 5:
                				$btn= '<option value="'.Yii::app()->request->baseUrl.'/priceGuide/showHockeyLine/?curr=5">SGD Singapore</option>';
                	...
                	<option value="<?php echo Yii::app()->request->baseUrl; ?>/priceGuide/showHockeyLine/?curr=0">USD North America</option>
                	<option value="<?php echo Yii::app()->request->baseUrl; ?>/priceGuide/showHockeyLine/?curr=1">CAD North America</option>
                	<option value="<?php echo Yii::app()->request->baseUrl; ?>/priceGuide/showHockeyLine/?curr=2">USD Europe and South America</option>
                	<option value="<?php echo Yii::app()->request->baseUrl; ?>/priceGuide/showHockeyLine/?curr=3">USD ASIA and Australia</option>
                	<option value="<?php echo Yii::app()->request->baseUrl; ?>/priceGuide/showHockeyLine/?curr=4">THB Thai Baht</option>
                	<option value="<?php echo Yii::app()->request->baseUrl; ?>/priceGuide/showHockeyLine/?curr=5">SGD Singapore</option>
                </select>
			...
			<table id="hockeyLineTable" class="table table-striped table-condensed table-freeze-multi table-bordered" data-scroll-height="600" data-cols-number="2" style="border-collapse: initial;">
				...
				<thead>
					<?php foreach ($getHeader as $key_header => $value_header) { ?>
						...
						<tr style="outline: 0px solid #252c2f;border: 1px solid #252c2f !important;">
							<th class="bg-blue text-center" style="outline: 0px solid #252c2f;border: 1px solid #252c2f !important;"></th>		
							<th class="bg-blue text-center " colspan="" style="outline: 0px solid #252c2f;border: 1px solid #252c2f !important;"><?php echo $value_header['r3c1_2']; ?></th>
							<th class="bg-blue text-center" style="outline: 0px solid #252c2f;border: 1px solid #252c2f !important;"></th>				
						...
						<?php
							foreach ($hockeyl as $category => $hockeylinevalue) {
								...
								<tr id="tr_<?php echo $value['id']; ?>">
									...
									<td id="prod_name<?php echo $value['id'];?>" class="" style="word-wrap:break-word;vertical-align: middle;background-color: #fff;outline: 1px solid #ddd;text-align: left;"><?php echo $value['style']; ?></td>
									<td id="prod_desc<?php echo $value['id'];?>" class="" style="word-wrap:break-word;vertical-align: middle;background-color: #fff;outline: 1px solid #ddd;text-align: left;"><?php echo nl2br($value['discription']).$show_addi_info; ?></td>
									<!--<td class=" nowrap bg-usd text-center" style="vertical-align: middle;"><?php //echo Helper::usFormat($value['qty1']." +"); ?></td>-->
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title"> Hockey Line - Add</h4>
			</div>
...
<div class="modal fade" id="editData" tabindex="-1" role="dialog">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
				<h4 class="modal-title"> Hockey Line - Edit</h4>
			</div>
			<div class="modal-body">
		...
		<div class="modal-content">
            ...
            <?php 
				...
				*/ ?>
				...
				<div class="form-group">
					<label class=" col-md-2 col-sm-3 col-xs-12"><?php echo $header->getAttributeLabel('r2c1'); ?></label>
					<div class="col-md-10 col-sm-6 col-xs-12">
						<?php echo $form->textArea($header, 'r2c1', array('class' => 'form-control', 'required' => true)); ?>
					</div>
				</div>

				<div class="form-group">
					<label class=" col-md-2 col-sm-3 col-xs-12"><?php echo $header->getAttributeLabel('r2c2'); ?></label>
					<div class="col-md-10 col-sm-6 col-xs-12">
						<?php echo $form->textArea($header, 'r2c2', array('class' => 'form-control', 'required' => true)); ?>
					</div>
				</div>
...
<div class="modal fade" id="editTopic" tabindex="-1" role="dialog">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
				<h4 class="modal-title">HockeyLine - Topic</h4>
			</div>
			<div class="modal-body">
            <?php 
            	$form=$this->beginWidget('CActiveForm', array(
