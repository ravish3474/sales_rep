...
<div class="form-group">
	<label class=" col-md-3 col-sm-3 col-xs-12"><?php echo $model->getAttributeLabel('fabric_options'); ?></label>
	<div class="col-md-9 col-sm-6 col-xs-12">
		<?php echo $form->textArea($model, 'fabric_options', array('class' => 'form-control', 'required' => true)); ?>
	</div>
</div>

<div class="form-group">
	<label class=" col-md-3 col-sm-3 col-xs-12"><?php echo $model->getAttributeLabel('style'); ?></label>
	<div class="col-md-9 col-sm-6 col-xs-12">
		<?php echo $form->textArea($model, 'style', array('class' => 'form-control', 'required' => true)); ?>
	</div>
</div>
...
<?php $header = HeaderSalesrep::model()->findAll("type = 'Tshirts'"); ?>
...
<?php $dheader = DheaderSalesrep::model()->findAll("type = 'Tshirts'"); ?>
...
<?php } ?>
<?php $dealersheaderheader = DealersheaderSalesrep::model()->findAll("type = 'Tshirts'"); ?>
