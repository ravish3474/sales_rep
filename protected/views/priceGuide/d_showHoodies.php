			...
			<div class="x_content">
                ...
                <select id="dynamic_select">
                	<?php
                		...
                		switch ($curr) {
                			case 0:
                				$btn= '<option value="'.Yii::app()->request->baseUrl.'/priceGuide/showHoodies/v/Sales_Dealers/?curr=0">USD North America</option>';
                				$curr_name='USD North America';
                				break;
                			case 1:
                				$btn= '<option value="'.Yii::app()->request->baseUrl.'/priceGuide/showHoodies/v/Sales_Dealers/?curr=1">CAD North America</option>';
                				$curr_name='CAD North America';
                				break;
                			case 2:
                				$btn= '<option value="'.Yii::app()->request->baseUrl.'/priceGuide/showHoodies/v/Sales_Dealers/?curr=2">USD Europe and South America</option>';
                				$curr_name='USD Europe and South America';
                				break;
                			case 3:
                				$btn= '<option value="'.Yii::app()->request->baseUrl.'/priceGuide/showHoodies/v/Sales_Dealers/?curr=3">USD ASIA and Australia</option>';
                				$curr_name='USD ASIA and Australia';
                				break;
                			case 4:
                				$btn= '<option value="'.Yii::app()->request->baseUrl.'/priceGuide/showHoodies/v/Sales_Dealers/?curr=4">THB Thai Baht</option>';
                				$curr_name='THB Thai Baht';
                				break;
                			case 5:
                				$btn= '<option value="'.Yii::app()->request->baseUrl.'/priceGuide/showHoodies/v/Sales_Dealers/?curr=5">SGD Singapore</option>';
                	...
                	<option value="<?php echo Yii::app()->request->baseUrl; ?>/priceGuide/showHoodies/v/Sales_Dealers/?curr=0">USD North America</option>
                	<option value="<?php echo Yii::app()->request->baseUrl; ?>/priceGuide/showHoodies/v/Sales_Dealers/?curr=1">CAD North America</option>
                	<option value="<?php echo Yii::app()->request->baseUrl; ?>/priceGuide/showHoodies/v/Sales_Dealers/?curr=2">USD Europe and South America</option>
                	<option value="<?php echo Yii::app()->request->baseUrl; ?>/priceGuide/showHoodies/v/Sales_Dealers/?curr=3">USD ASIA and Australia</option>
                	<option value="<?php echo Yii::app()->request->baseUrl; ?>/priceGuide/showHoodies/v/Sales_Dealers/?curr=4">THB Thai Baht</option>
                	<option value="<?php echo Yii::app()->request->baseUrl; ?>/priceGuide/showHoodies/v/Sales_Dealers/?curr=5">SGD Singapore</option>
                </select>
					...
					<table id="hoodiesTable" class="table table-striped table-condensed table-freeze-multi table-bordered" data-scroll-height="600" data-cols-number="2" style="border-collapse: initial;">
						...
						<thead>
							<?php foreach ($getDheader as $key_header => $value_header) { ?>
								<tr>
									<th class="bg-blue-light text-center" rowspan="2"><button class="btn btn-success" data-toggle="modal" data-target="#editHeader" data-id="<?php echo $value_header['id'];?>">
										Edit
									</button>  </th>
						...
						<tbody>
							...
							<tr id="tr_<?php echo $value['id']; ?>">
								...
								<td style="word-wrap:break-word;vertical-align: middle;background-color: #fff;outline: 1px solid #ddd;text-align: left;"><?php echo nl2br($value['discription']); ?></td>
	...
	<div class="modal-dialog">
		<div class="modal-content">
            ...
            <?php 
				...
				<div class="form-group">
					<label class=" col-md-2 col-sm-3 col-xs-12"><?php echo $d_header->getAttributeLabel('r1c3'); ?></label>
					<div class="col-md-10 col-sm-6 col-xs-12">
						
						<?php echo $form->textArea($d_header, 'r1c3', array('class' => 'form-control', 'required' => true)); ?>
					</div>
				</div>

				<div class="form-group">
					<label class=" col-md-2 col-sm-3 col-xs-12"><?php echo $d_header->getAttributeLabel('r1c4'); ?></label>
					<div class="col-md-10 col-sm-6 col-xs-12">
						<?php echo $form->textArea($d_header, 'r1c4', array('class' => 'form-control', 'required' => true)); ?>
					</div>
				</div>
