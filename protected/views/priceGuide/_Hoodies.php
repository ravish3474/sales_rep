...
<?php $header = HeaderSalesrep::model()->findAll("type = 'Hoodies'"); ?>
...
<?php $dheader = DheaderSalesrep::model()->findAll("type = 'Hoodies'"); ?>
...
<?php } ?>
<?php $dealersheaderheader = DealersheaderSalesrep::model()->findAll("type = 'Hoodies'"); ?>
