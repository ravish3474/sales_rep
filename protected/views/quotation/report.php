		...
		<div class="x_panel">
			...
			<div class="x_title">
				<div>
					...
					<a class="btn btn-success download-btn" style="float: right;" onclick="return $('#form_download_xls').submit();">Download Excel</a>

				</div>
				<div style="float: left; margin-top: 5px;" class="from-all-reports-handle">
								...
								if ($user_row["user_group_id"] != $tmp_group) {
									...
									switch ($tmp_group) {
										case "1":
											...
											break;
										case "2":
											$show_group = "Sales Direct";
											break;
										case "3":
											$show_group = "Sales Dealers";
											break;
										case "4":
											$show_group = "Dealers";
											break;
				...
				<div style="float:right;  text-align: right;" class="from-all-pages-handle">
					...
					<input type="checkbox" id="chk_show_have_inv" <?php if ($have_inv_show == "yes") {
																		echo "checked";
																	} ?> onclick="changeShowHaveINV();">
					Added INV No. |
					<input type="hidden" id="show_desc_value" value="<?php echo $desc_show; ?>">
					<input type="checkbox" id="chk_show_desc" <?php if ($desc_show == "yes") {
																	echo "checked";
			...
			<div class="x_content">
				...
				<div class="scrollTable">
					<table class="tbl_content" style="width: 100%;">
						...
						?>
							<tr <?php if ($row_quote_doc["is_editing"] == "2") {
