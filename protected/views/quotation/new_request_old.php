		...
		<div class="x_panel">
			...
			<div class="x_title">
				...
				<div class="page-selecting">
					...
					Found <font class="page-selecting-total-page"><?php echo number_format($num_data); ?></font> rows<br>
				...
				<table class="tbl_content " style="width: 100%;">
					...
					?>
						...
						<tr <?php if ($row_quote_doc["is_editing"] == "1" && ($user_group == "1" || $user_group == "99")) {
							...
							<td class="POnumberForApproved"><?php echo $row_quote_doc["po_number"]; ?></td>
