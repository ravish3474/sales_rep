...
#fixed-btn {
    ...
    transition: position 0.3s ease-in-out; /* Add a transition effect for smooth change */
}
...
.results-container {
    ...
    overflow-y: auto; /* Add a scrollbar when content exceeds the maximum height */
...
.dataTables_wrapper .dataTables_filter input{
    ...
    background-color: #e6eff687;
}
th{
    white-space: collapse;
}
select#edit_reqby_user_id {
    width: 100%;
    padding: 6px;
    background: #ECF3F9;
    border-radius: 1px;
...
<div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
        ...
        <div class="row" style="border: 1px solid #eee; margin-bottom:10px;">
            <div class="col-lg-5 col-md-12 col-sm-12 col-12 float top-left-side">
            <div class="card">
                <div class="card-body">
            ...
            <div class="col-sm-3 d-flex justify-content-between upload-report">
                <div class="form-group text-right">
                    <h2 class="card-title" for="exampleFormControlSelect1">Upload Online Store Report</h2>
        ...
        <div class="row">
            ...
            <table class="table table-bordered quote_table" id="quote_table">
                <thead>
                <tr>
                    <th colspan="5" style="background-color:black;color:white;"><?php
                ...
                ?>>
                    ...
                    ?>
                    <button class="btn btn-danger rollback" jog_code="<?=$data['jog_code']?>" fname="<?=$data['conv_by']?>" conv_id="<?=$data['conv_id']?>"  style="background: #007f7f; border-color: #007f7f;">Cancel Quotation</button>
            ...
            <div class="modal-body">
                ...
                <form class="form-horizontal" id="update_requested_ajax">
                    ...
                    <div class="form-group">
                        <label class="control-label col-sm-2" for="pwd">Notes:</label>
                        <div class="col-sm-12">
                            <textarea class="form-control w-100" name="update_notes" required></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        <!-- <label class="control-label col-sm-2" for="pwd">Old Request<br>(if any):</label> -->
...
function openQuotationData(type,conv_id,file_name,notes){
    ...
    if(file_name.length>0){
        ...
        if(fileExt=='pdf'){
            var url= "https://sales.jog-joinourgame.com/upload/samples/"+file_name;
                ...
                if (resp.result == "success") {
                    ...
                    inv_no.forEach(function(value, key) {
                        ...
                        if (inv_link[key]) {
                            ...
                            html += '<a href="' + trimmedValue + '" target="_blank"  class="' + cls + '">' + value + '</a> <br>';
                        } else {
...
<div class="modal fade" id="wave_modal" tabindex="-1" role="dialog">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                ...
                                <span class="btn btn-primary sync_btn">Sync</span>
                            </div>
