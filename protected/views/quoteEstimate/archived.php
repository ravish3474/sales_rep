...
<div class="container">
    <div class="row">
        <div class="col-sm-6">
            <div class="card">
                <div class="card-body">
                    <h2 class="card-title">Archived Quotations</h2>
                    <form class="form-inline" action="archived" method="POST">
                    ...
                    ?>
                        <tr <?php
                            ...
                            <td>
                                ...
                                <?php } else { ?>
                                    <a href="<?= $data['invoice_link'] ?>" target="_blank"><button class="btn btn-success btn-md btn_link_view" style="width:100%">View</button></a>
                                <?php
                                }
                                if ($user_group == "99" || $user_group == "1") {
                                ?>
                                    <i class="fa fa-pencil btn_edit_inv" id="d_inv_link<?= $data['qdoc_id'] ?>" data-toggle="modal" data-target="#editINVNOModal" onclick="return editInvoiceLink(<?= $data['qdoc_id'] ?>);"></i>
                                <?php } ?>
                            </td>
                            <!--<td>-->
                            <?php
                            ...
                            <td>
                                ...
                                if ($user_group == "99" || $user_group == "1") {
                                    if ($data['request_update'] == 1) {
                                ?>
                                        <button class="btn btn-warning" onclick="openRequest('<?= $data['conv_id'] ?>','<?= $data['conv_by_id'] ?>')">Update Requested</button>
                                    <?php
                                    }
                                    ?>
                                    <button class="btn btn-danger" onclick="deleteConv(<?= $data['conv_id'] ?>)">Delete</button>
                                    <?php
                                } else {
                                    if ($data['request_update'] == 0) {
                                    ?>
                                        <button class="btn btn-danger" data-toggle="modal" data-target="#requestUpdateModal" onclick="requestData('<?= $data['jog_code'] ?>','<?= $data['conv_id'] ?>')">Request Update</button>
                                    <?php
                                    } else {
                                    ?>
                                        <button class="btn btn-warning">Update Requested</button>
                                <?php
                                    }
                                }
                                ?>
    ...
    <div class="modal-dialog" style="width:500px;">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div style="color: #F00; font-size: 14px; text-align: center; width: 100%; padding: 0px; margin:0px;">Enter Complete Link to the invoice<br><u>Ex</u>: https://www.example.com</div>
            </div>
            <div class="modal-footer">
...
<script>
    ...
    function requestData(jog_code, conv_id) {
