...
/**
 * This is the model class for table "soccer".
 *
 * The followings are the available columns in table 'soccer':
 * @property integer $id
 ...
 */
class Soccer extends CActiveRecord
{
	/**
	 ...
	 * @return Soccer the static model class
	 */
	...
	{
		$model = Soccer::model()->findByPk($post['id']);
		$model->attributes = $post;
