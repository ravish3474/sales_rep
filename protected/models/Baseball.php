...
/**
 * This is the model class for table "baseball".
 *
 * The followings are the available columns in table 'baseball':
 * @property integer $id
 ...
 */
class Baseball extends CActiveRecord
{
	/**
	 ...
	 * @return Baseball the static model class
	 */
	...
	{
		$model = Baseball::model()->findByPk($post['id']);
		$model->attributes = $post;
