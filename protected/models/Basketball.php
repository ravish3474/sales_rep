...
/**
 * This is the model class for table "basketball".
 *
 * The followings are the available columns in table 'basketball':
 * @property integer $id
 ...
 */
class Basketball extends CActiveRecord
{
	/**
	 ...
	 * @return Basketball the static model class
	 */
	...
	{
		$model = Basketball::model()->findByPk($post['id']);
		$model->attributes = $post;
