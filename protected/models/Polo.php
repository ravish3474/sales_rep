 ...
 *
 * The followings are the available columns in table 'polo':
 * @property integer $id
 * @property string $qty_name
 ...
 */
class Polo extends CActiveRecord
{
	/**
	 ...
	 * @return Polo the static model class
	 */
	...
	{
		$model = Polo::model()->findByPk($post['id']);
		$model->attributes = $post;
