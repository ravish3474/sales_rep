...
/**
 * This is the model class for table "tracksuits".
 *
 * The followings are the available columns in table 'tracksuits':
 * @property integer $id
 ...
 */
class Tracksuits extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('category, discription, style', 'required'),
			...
			array('id, category, discription, style, qty1, qty2, qty3, qty4, qty5, qty6, qty7, qty8, qty9, qty10, qty11, qty12, qty13, qty14, qty15, cad, thai, asia, msrp, notes, d_qty1, d_qty2, d_qty3, d_qty4, d_qty5, d_qty6, d_qty7, d_qty8, d_qty9, d_msrp, dealers_qty1, dealers_qty2, dealers_qty3, dealers_msrp, d_notes, sort_data', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return Tracksuits the static model class
	 */
	...
	{
		$model = Tracksuits::model()->findByPk($post['id']);
		$model->attributes = $post;
